...
# Report metadata
FIRM_NAME      = "Sapala LLP"
SALES_REP      = "Nick Holderman"
OUTPUT_PATH    = "sapala-law/Sapala Law_July 27, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "RED",   "Zero paid marketing"),   # Lead Generation
    ("RED",   "RED",   "No intake process"),      # Intake
    ("RED",   "RED",   "Solo founder, no team"),  # Team
...
FINDINGS = [
    ("neg", "Brandon is the firm's only operator — every deal and dollar runs through him, with no team to absorb growth"),
    ("neg", "No intake process — referrals depend entirely on Brandon's personal availability, even after hours"),
    ("neg", "Zero paid lead generation in 5 months — growth is capped by the size of Brandon's personal network"),
    ("pos", "Collections nearly doubled in 3 months ($28K to $43K) with zero marketing spend — real market demand"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Buist Byars & Taylor",   "Not verified", "AV-rated · entrenched"),
    ("Graybill Lansche & Vinzani", "Not verified", "Boutique · 2 SC markets"),
    ("Cipolla Cox, LLC",       "50 reviews (Birdeye)", "Residential closings leader"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $85K/Month"

SMB_MODEL_DESC = (
    "All four pillars — lead generation, intake, team, and profit — must work "
    "together, or growth stalls no matter how strong the referrals are. When "
    "they do, Brandon can finally step back and become the rainmaker instead "
    "of the whole operation."
)

GOAL_HEADLINE = "$43K → $85K/mo collected"
GOAL_DBM      = "Become the rainmaker, not the whole firm"
...
PRIORITIES = [
    (
        ...
        [
            "Launch Google Search ads on core practice terms",
            "Turn Google into a pipeline that runs without you",
            "Claim & complete the Google Business Profile",
            "Rebuild homepage with a clear CTA & contact form",
            "Bid on competitor names Charleston firms miss",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Add a phone number & form above the fold",
            "Build a simple lead follow-up process",
            "Cover after-hours referral calls",
            "Track every inquiry so none go cold",
            "Free Brandon from being the entire intake team",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Start Elite Coach Plus to build team structure",
            "Hire first support role for intake & ops",
            "Close the billed-vs-collected cash gap",
            "Build a real profit plan, not just revenue",
            "Add a Fractional COO as the firm scales",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,997", "$5,697/mo",
        "Google Search Ads · Local SEO · Website/CTA fixes · GBP",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $3,500–$14,000/mo paid directly to Google — not to SMB Team"
)

AVG_CASE_VALUE     = "$5,000 (category default)"
CONSERVATIVE_LABEL = "Conservative  (4 cases/mo):"
CONSERVATIVE_RESULT = "$20,000 revenue · 5.7× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (19 cases/mo):"
AGGRESSIVE_RESULT  = "$95,000 revenue · 6.8× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch Google Search test campaign"),
    ("Day 14",  "Homepage CTA & contact form rebuild live"),
    ("Week 2",  "Elite Coach Plus coaching kickoff begins"),
    ("Week 3",  "Google Business Profile fully built out"),
    ("Month 3", "Billed-vs-collected reconciliation habit set"),
]

CLOSING_QUOTE = (
    '"I want to become the rainmaker — not the whole firm."'
)
