...
OUTPUT_PATH    = "mbd-law/MBD_Law_July_8_2026_Proposal.pptx"
...
PILLARS = [
    ("AMBER", "AMBER", "GBP miscategorized"),       # Lead Generation
    ("AMBER", "AMBER", "75% close; gaps upstream"), # Intake
    ("AMBER", "AMBER", "DOO 2024; systems building"), # Team
    ("AMBER", "AMBER", "No cost-per-case data"),     # Profit Plan
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "GBP listed as 'General Law Firm' — $10K/mo LSA spend is structurally suppressed while competitors with correct category capture Bergen County's top family law searches"),
    ("neg", "No Meta advertising running — entire paid social channel unclaimed while competitors build brand awareness before prospects ever search Google"),
    ("neg", "Website contact form buried at bottom — ad-driven visitors who don't scroll have no visible way to reach the firm, losing consultations from paid traffic"),
    ("pos", "86 Google reviews at 4.8 stars — more reviews than Burke Williams (69), and a 75% consultation close rate that is exceptional for Bergen County family law"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Burke Williams, LLC",                "69 reviews", "4.9 ★ · Best of Bergen 2026"),
    ("Weinberger Divorce & Family Law",    "Dominant NJ",  "Statewide firm · correct cat."),
    ("Weiner Law Group LLP",               "35+ yrs",      "High-asset divorce focus"),
]
CLIENT_REVIEWS      = "86 reviews · 4.8 ★"
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $250K/Month"

SMB_MODEL_DESC = (
    "Lead Generation, Intake, Team, and Profit must all work together — "
    "fixing one without the others only moves the bottleneck. "
    "When all four pillars run as a system, MBD Law reaches $10M on "
    "predictable infrastructure, not on luck or who called that week."
)

GOAL_HEADLINE = "$2.0M → $10M revenue"
GOAL_DBM      = "Growth that is real, predictable, and not dependent on luck"
...
PRIORITIES = [
    (
        ...
        [
            "Fix GBP category: unlock $10K/mo LSA instantly",
            "Expand PPC past $2,500 — win Bergen County terms",
            "Launch Meta retargeting for warm website visitors",
            "Build review system to 200+ Google reviews",
    ...
    (
        ...
        [
            "Add above-fold contact form to homepage",
            "Create after-hours lead capture for missed calls",
            "Build consultation follow-up for non-converted leads",
            "Formalize intake scripts to protect 75% close rate",
            "Track leads → consults → signed cases by channel",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "FCOO Director builds ops systems with Natalie",
            "Design intake protocol for scale to 25 clients/mo",
            "Set up channel-level marketing attribution dashboard",
            "Add quarterly profit planning with revenue targets",
            "Build talent pipeline for the $10M growth trajectory",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$10,497", "$12,497/mo",
        "Google Ads · LSA · Meta Ads · SEO · GBP Optimization · Website",
        "1D4ED8",
    ),
    (
        "MASTER'S CIRCLE + FCOO DIRECTOR",
        "$5,394", "$7,794/mo",
        "Group Coaching · Masterminds · FCOO Director · Workshops",
        "6D28D9",
    ),
]

BUNDLE_TOTAL   = "$15,891 / mo"
BUNDLE_SAVINGS = "Save $4,400/mo by bundling"

AD_SPEND_NOTE = (
    "+ Recommended ad spend: $3,500–$14,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE     = "~$10,000 (est.)"
CONSERVATIVE_LABEL = "Conservative  (6 cases/mo):"
CONSERVATIVE_RESULT = "$60,000 revenue · 17× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (28 cases/mo):"
AGGRESSIVE_RESULT  = "$280,000 revenue · 20× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Fix GBP category — unlock full LSA delivery"),
    ("Day 14",  "Launch restructured Google Ads + Meta retargeting"),
    ("Week 2",  "Begin FCOO Director + Master's Circle coaching"),
    ("Week 3",  "Rebuild homepage for above-fold contact capture"),
    ("Month 3", "Attribution dashboard live; first ROI review call"),
]

CLOSING_QUOTE = (
    '"Build a firm that hits $10M — so the growth is real, predictable, '
    'and not dependent on luck or a referral that didn\'t show up for 10 days."'
)
