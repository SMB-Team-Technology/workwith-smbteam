...
# Report metadata
FIRM_NAME      = "McAdoo Estate Planning, LLC"
SALES_REP      = "Dan Bryant"
OUTPUT_PATH    = "mcadoo-estate-planning/McAdoo Estate Planning, LLC_July 9, 2026_Proposal.pptx"
...
PILLARS = [
    ("AMBER", "AMBER", "Generalist ad vendor"),
    ("AMBER", "AMBER", "No after-hours coverage"),
    ("AMBER", "AMBER", "Scott is the bottleneck"),
    ("RED",   "CRITICAL", "No financial visibility"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "Homepage still leads with probate, not estate planning."),
    ("neg", "3 mismatched NAP listings undermine your local SEO trust."),
    ("neg", "Ad spend rose to $8K/mo with no cost-per-case tracking."),
    ("pos", "Your 4.9-star, 273-review profile beats every named competitor."),
]

COMPETITORS = [
    ("Morgan Legal Group",  "154 reviews", "5.0★ · geo pages"),
    ("Roman Aminov",        "41 reviews",  "5.0★ · branch page"),
    ("Simon & Gilman",      "128 reviews", "4.4★ · Queens Blvd"),
]
CLIENT_REVIEWS      = "273 reviews"
CLIENT_REVIEWS_NOTE = "← You are here"

STAGE_TEXT = "Stage 4: Small Business Manager  →  Goal: Stage 6, Law Firm Owner"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $500,000/Month"

SMB_MODEL_DESC = (
    "All four pillars — marketing, intake, team, and profit — must work "
    "together, or growth stalls no matter how much you spend on ads. "
    "When all four work together, Scott can finally stop patching every "
    "gap by hand and start running the firm instead of rescuing it."
)

GOAL_HEADLINE = "$3M → $6M revenue"
GOAL_DBM      = "Systems that run without you holding it together"

PRIORITIES = [
    (
        "Build the", "Marketing Engine", "1D4ED8",
        [
            "Replace Grow My Ads with legal-specific ads",
            "Rebalance the site to lead with estate planning",
            "Fix NAP data across Avvo, Justia, Yelp",
            "Build geo pages for Queens Village, Hollis",
            "Turn Google Ads into a pipeline that runs itself",
        ],
    ),
    (
        ...
        [
            ...
            "Automate CRM hygiene, stop manual tracking",
            "Build a follow-up sequence for cold leads",
            "Streamline the consultation booking flow",
            "Free Scott from chasing every lead by hand",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Take vendor coordination off Scott's plate",
            "Launch Elite Coach Plus for Kim and Scott",
            "Track cost-per-case across every practice area",
            "Bring the Garden City office fully online",
            "Build a firm that runs without Scott doing it all",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$15,997", "$18,997/mo",
        "Legal-specific ads · Local SEO/NAP · Geo pages · Meta launch",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
...
AVG_CASE_VALUE      = "$1,500–$3,000"
CONSERVATIVE_LABEL  = "Conservative  (3 cases/mo):"
CONSERVATIVE_RESULT = "$6,750 revenue · 1.9× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (25 cases/mo):"
AGGRESSIVE_RESULT   = "$56,250 revenue · 4.0× ROAS"

TIMELINE = [
    ("Day 1",   "Launch legal-specific Google Ads & LSA mgmt"),
    ("Day 14",  "Clean up NAP across Avvo, Justia, Yelp"),
    ("Week 2",  "Rebalance site toward estate planning"),
    ("Week 3",  "Launch geo pages & Meta retargeting"),
    ("Month 3", "Kick off Elite Coach Plus with Kim & Scott"),
]

CLOSING_QUOTE = (
    '"I want a system that runs the marketing and intake — so I\'m not '
    'the one patching every gap."'
)
