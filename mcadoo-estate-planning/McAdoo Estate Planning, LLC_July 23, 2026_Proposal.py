...
OUTPUT_PATH    = "mcadoo-estate-planning/McAdoo Estate Planning, LLC_July 23, 2026_Proposal.pptx"
...
FINDINGS = [
    ...
    ("neg", "NAP errors now spreading into Google's own review data."),
    ("neg", "Ad spend rose to $8K/mo with no cost-per-case tracking."),
    ("pos", "Your 4.9-star, 275-review profile beats every named competitor."),
]

COMPETITORS = [
    ("Morgan Legal Group",  "157 reviews", "5.0★ · geo pages"),
    ("Roman Aminov",        "41 reviews",  "5.0★ · branch page"),
    ("Simon & Gilman",      "128 reviews", "4.4★ · Queens Blvd"),
]
CLIENT_REVIEWS      = "275 reviews"
