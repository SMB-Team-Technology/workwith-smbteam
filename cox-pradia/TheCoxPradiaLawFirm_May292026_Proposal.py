...
# ═══════════════════════════════════════════════════════════════════
# FILL — All placeholders replaced with Cox Pradia audit data
# ═══════════════════════════════════════════════════════════════════
...
PILLARS = [
    ("RED",   "CRITICAL", "No paid ads — invisible"),
    ("AMBER", "AMBER",    "No live chat or after-hrs"),
    ("AMBER", "AMBER",    "No mgmt layer in place"),
    ("RED",   "CRITICAL", "No revenue visibility"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "Invisible on Google Ads + 3-pack while Zehl spends $913K/yr on PI terms"),
    ("neg", "Two addresses + three phone numbers across directories hurt 3-pack ranking"),
    ("neg", "No live chat + footer-only form — after-hours PI visitors leave unconverted"),
    ("pos", "Structured 10-person team — intake coordinators + case manager — ready to scale"),
]

COMPETITORS = [
    ("Zehl & Associates",          "1,262 reviews", "5.0★ · $913K ads/yr"),
    ("Simmons and Fletcher, P.C.", "502 reviews",   "4.9★ · $384K ads/yr"),
    ("Terry Bryant Injury Law",    "100 reviews",   "4.6★ · $272K ads/yr"),
]
CLIENT_REVIEWS      = "51 reviews"
CLIENT_REVIEWS_NOTE = "← You are here"

STAGE_TEXT = "Stage 4: Small Business Manager  →  Stage 6: Law Firm Owner"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Build a Firm That Runs Without You"

SMB_MODEL_DESC = (
    "Four pillars power every thriving law firm: Lead Generation, Intake, "
    "Team, and Profit. Today, Cox Pradia has the team and the talent — but "
    "two pillars are red and two are amber. This plan builds what is missing. "
    "When all four pillars work together, Cox and Pradia can step back from "
    "daily operations and let the firm generate the cases, the revenue, and "
    "the freedom their 40 years of work have earned."
)

GOAL_HEADLINE = "Stage 4 → Stage 6 Firm"
GOAL_DBM      = "A firm that generates cases — and runs without you chasing them"

PRIORITIES = [
    (
        "Build the", "Marketing Engine", "1D4ED8",
        [
            "Turn Google into a PI case pipeline for Cox Pradia",
            "Activate LSA — pay per qualified lead, not per click",
            "Fix 2-address NAP issue — reclaim 3-pack eligibility",
            "Build suburb pages: Katy, Sugar Land, The Woodlands",
            "Launch review system — close the 24x gap vs. Zehl",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Add above-fold form — capture leads before they scroll",
            "Digital after-hours capture for late-night PI contacts",
            "Activate Avvo reviews — 0 on a 27-year attorney profile",
            "Spanish-language intake — Houston is 44% Hispanic",
            "Track lead source at intake — know what converts",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Set monthly case + lead targets with Master's Circle",
            "Peer accountability with $1M+ PI firm owners",
            "Implement case acquisition cost tracking from day one",
            "Build a mgmt layer — so partners choose their focus",
            "Define revenue goal — engineer profit from the start",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$7,397", "$8,997/mo",
        "Google Ads · LSA · Meta · Full SEO · Website Optimization",
        "1D4ED8",
    ),
    (
        "MASTER'S CIRCLE",
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $19,500–$50,000/mo paid directly to Google/Meta/LSA"
)
...
AGGRESSIVE_RESULT   = "$850,000 revenue · 17× ROAS"

TIMELINE = [
    ("Day 1",   "Google Ads + LSA campaigns launched and live"),
    ("Day 14",  "NAP corrections submitted to all directories"),
    ("Week 2",  "Above-fold form + suburb landing pages live"),
    ("Week 3",  "Automated review request system activated"),
    ("Month 3", "Coaching kickoff — revenue goal + targets set"),
]

CLOSING_QUOTE = (
    "“For 40 years, you’ve fought for people who couldn’t fight for themselves. "
    "Now it’s time for your firm to fight for you — generating the cases, the revenue, "
    "and the freedom your work has earned.”"
)
