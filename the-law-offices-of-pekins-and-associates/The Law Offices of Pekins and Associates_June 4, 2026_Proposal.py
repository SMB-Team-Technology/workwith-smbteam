...
# Report metadata
FIRM_NAME      = "The Law Offices of Pekins and Associates, PLLC"
SALES_REP      = "Randy Gold"
OUTPUT_PATH    = "the-law-offices-of-pekins-and-associates/The Law Offices of Pekins and Associates_June 4, 2026_Proposal.pptx"
...
PILLARS = [
    ...
    ("RED",   "CRITICAL", "No intake staff"),
    ("RED",   "CRITICAL", "Solo; no delegation"),
    ("AMBER", "AMBER",    "No profit visibility"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — 3 neg + 1 pos
FINDINGS = [
    ("neg", "Expired SSL warns visitors away before they read a word"),
    ("neg", "Zero paid ads — invisible to every prospect searching now"),
    ("neg", "30 Google reviews vs. 1,364 for The Gonzalez Law Group"),
    ("pos", "5.0-star Google rating — the quality reputation is real"),
]

# Competitor table
COMPETITORS = [
    ("The Gonzalez Law Group",  "1,364 reviews", "PI · criminal · estate"),
    ("Scheiner Law Group",      "114 reviews",   "Board-certified criminal"),
    ("WestLoop Law",            "100+ reviews",  "PI · same South Loop block"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Build a $1M+ Practice"

SMB_MODEL_DESC = (
    "Lead generation, intake, team, and profit — all four must work together. "
    "When they do, Attorney Perkins-Mouton can finally serve more of Houston "
    "without carrying every part of the firm on her own."
)

GOAL_HEADLINE = "~$500K → $1M+ revenue"
GOAL_DBM      = "Serve your community — and get your life back"
...
PRIORITIES = [
    (
        ...
        [
            "Rebuild site: SSL, mobile design, CTAs on every page",
            "Turn Google into a PI pipeline that runs without you",
            "Launch LSA — appear above every competitor on page 1",
            "Build review velocity to reach 3-pack threshold",
            "Target expungement niche — 29 years is your moat",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Build intake process with scripts and CRM tracking",
            "Add after-hours coverage — stop losing after-5pm leads",
            "Create follow-up sequences for hesitant prospects",
            "Track every lead source to measure what converts",
            "Every new client finds a system, not just the attorney",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Hire and train intake coordinator as first team member",
            "Document processes so cases run without the attorney",
            "Track profit by case type — know your most valuable work",
            "Build a financial forecast to plan growth confidently",
            "Build the firm that carries your mission forward",
        ],
    ),
]
...
PACKAGES = [
    ...
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "Weekly coaching · Intake build · Profit planning · Workshops",
        "6D28D9",
    ),
]
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $6,000–$10,000/mo paid directly to Google/LSA/Meta"
)
...
TIMELINE = [
    ("Day 1",   "Launch Google Ads + LSA for PI & criminal defense"),
    ("Day 14",  "Website rebuild begins: SSL + practice area pages"),
    ("Week 2",  "Launch review-request system (24-hr text after close)"),
    ("Week 3",  "Coaching kickoff: baselines, intake map, first hire"),
    ("Month 3", "NAP cleanup + GBP optimization across all directories"),
]

CLOSING_QUOTE = (
    '"I want the firm to carry the work forward — with the same values, '
    'the same care, and without me needing to be there for every single case."'
)
