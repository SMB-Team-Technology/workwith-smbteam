"""
Audit PowerPoint — The Law Offices of Perkins and Associates, PLLC
June 4, 2026 | Rep: Randy Gold
Packages: Full Service Marketing Starter + FCOO Advisor + Fractional CTO Level 1
"""
...
FIRM_NAME   = "The Law Offices of Perkins and Associates, PLLC"
SALES_REP   = "Randy Gold"
OUTPUT_PATH = "the-law-offices-of-pekins-and-associates/The Law Offices of Perkins and Associates_June 4, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL",    "SSL expired · no ads"),
    ("RED",   "CRITICAL",    "Solo · no intake staff"),
    ("RED",   "CRITICAL",    "No team · solo structure"),
    ("AMBER", "IN PROGRESS", "No profitability data"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "Expired SSL warns every visitor away before they see the firm's name"),
    ("neg", "Zero paid ads — invisible to thousands searching in Houston daily"),
    ("neg", "30 reviews vs. 1,364+ competitors — absent from every local 3-pack"),
    ("pos", "5.0 Google stars, 29 years, powerful Queen of Justice brand identity"),
]

COMPETITORS = [
    ("The Gonzalez Law Group",  "1,364 reviews", "PI · crim def · estate · all channels"),
    ("Scheiner Law Group",      "114 reviews",   "criminal defense · LSA + Google Ads"),
    ("WestLoop Law",            "Active",         "1 mile away · PI ads in South Loop"),
]
CLIENT_REVIEWS      = "30 reviews (5.0 ★)"
CLIENT_REVIEWS_NOTE = "← You are here"

STAGE_TEXT = "Stage 3 — Solo Practitioner  →  Goal: Stage 5, Law Firm CEO"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $1M in Revenue"

SMB_MODEL_DESC = (
    "When Marketing, Intake, Team, and Profit all work together, "
    "growth becomes predictable — not dependent on referrals or your "
    "personal presence in every seat. When all four pillars are in "
    "place, Trina can step back and let the firm carry her mission "
    "forward at scale."
)

GOAL_HEADLINE = "$500K → $1M revenue"
GOAL_DBM      = "A practice that serves the community — and runs without you in every chair"

PRIORITIES = [
    (
        "Build the", "Marketing Engine", "1D4ED8",
        [
            "Rebuild website — SSL fixed, mobile-ready",
            "Launch Google Ads for PI and expungement",
            "Enroll in LSA — appear above all results",
            "Drive review growth toward 3-pack threshold",
            "Meta retargeting for PI and criminal leads",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Build intake process — no lead falls through",
            "Add after-hours coverage for PI calls",
            "5-minute web lead response — every inquiry",
            "Intake scripts that retain, not just log",
            "Track and qualify every inbound call",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Hire first intake coordinator — create leverage",
            "FCOO maps operations — attorney steps back",
            "AI handles routine intake and follow-up",
            "Profit by practice area — focus what earns",
            "Know what you earn and keep each month",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,847", "$5,697/mo",
        "Website rebuild · Google Ads · LSA · Meta · Local SEO",
        "1D4ED8",
    ),
    (
        "FCOO ADVISOR + FRACTIONAL CTO — LEVEL 1",
        "$6,594", "$7,594/mo",
        "Fractional COO · Group coaching · AI Skills · CTO sessions",
        "6D28D9",
    ),
]

BUNDLE_TOTAL   = "$11,441 / mo"
BUNDLE_SAVINGS = "Save $1,850/mo by bundling"

AD_SPEND_NOTE = (
    "+ Recommended ad spend: $6,000–$10,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE      = "$8,000"
CONSERVATIVE_LABEL  = "Conservative  (1–2 cases/mo):"
CONSERVATIVE_RESULT = "~$12,000 revenue · 2.0× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (3–4 cases/mo):"
AGGRESSIVE_RESULT   = "~$24,000 revenue · 2.4× ROAS"

TIMELINE = [
    ("Day 1",   "Google Ads + LSA campaigns go live"),
    ("Day 14",  "Website rebuild begins · SSL restored"),
    ("Week 2",  "FCOO + CTO Foundation Sprint kickoff"),
    ("Week 3",  "Review request system launched"),
    ("Month 3", "NAP cleanup done · GBP optimized"),
]

CLOSING_QUOTE = (
    '"Twenty-nine years of earned trust and a 5.0-star reputation are sitting behind '
    'a broken website — the systems to unlock that legacy can be in place within 90 days."'
)
