...
# Report metadata
FIRM_NAME      = "Vento Law Firm"
SALES_REP      = "Nick Holderman"
OUTPUT_PATH    = "vento-law-firm/VentoLawFirm_June24_2026_Proposal.pptx"
...
PILLARS = [
    ("RED", "CRITICAL", "No paid ads ever run"),      # Lead Generation
    ("RED", "CRITICAL", "No after-hours coverage"),   # Intake
    ("RED", "CRITICAL", "Solo, zero staff"),           # Team
    ("RED", "CRITICAL", "Revenue contracting"),        # Profit Plan
]
...
FINDINGS = [
    ("neg", "Case volume fell from 25 to 10 active matters — revenue crisis in progress"),
    ("neg", "No paid ads ever run; invisible in local search for every tested Tampa keyword"),
    ("neg", "32 reviews — below every competitor with local pack or LSA visibility"),
    ("pos", "5.0 rating, bilingual English/Spanish, Rising Stars 2026 — ready to scale"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
# List 3 competitors + the client row is added automatically.
COMPETITORS = [
    ("Daniel J. Fernandez, P.A.", "570 reviews", "Paid ads · 43 yrs · courthouse"),
    ("Sammis Law Firm",           "161 reviews", "6 attys · 3 offices · LSA"),
    ("Hersem Law",                "98 reviews",  "Best DUI Tampa · 5 yrs"),
]
CLIENT_REVIEWS      = "32 reviews"
CLIENT_REVIEWS_NOTE = "← You are here"

# Stage strip (right panel, Slide 1)
STAGE_TEXT = "Stage 3: Solo Practitioner  →  Stage 6: Law Firm Owner"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach 20+ Cases/Month"

SMB_MODEL_DESC = (
    "Lead Generation, Intake, Team, and Profit must "
    "all work together. When any one is missing, "
    "growth stalls regardless of effort invested. "
    "When all four run, Idalis builds the firm that "
    "generates cases — and runs without her at the "
    "center of every decision."
)

GOAL_HEADLINE = "$180K → $360K+ Revenue"
GOAL_DBM      = "Choose every case — stop taking them out of fear"
...
PRIORITIES = [
    (
        ...
        [
            "Turn Google into a client pipeline — week one",
            "Launch LSAs to own the top of every local search",
            "Spanish-language ads — a market no one is claiming",
            "Review campaign: 75+ reviews, full LSA power",
            "Website rebuilt to convert the crisis-moment call",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Contact form above fold — capture after-hours call",
            "Urgency language for the arrested-tonight visitor",
            "After-hours coverage: no call goes unanswered",
            "Intake scripts that qualify leads and book consults",
            "Track which leads become clients — know your ROI",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Coaching kickoff: goals, plan, 90-day milestones",
            "Hire intake coordinator as first team member",
            "Track profit by case type — optimize what you take",
            "Build financial clarity toward the building goal",
            "Roadmap to the firm that runs without you",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$3,397", "",
        "Website · Google Ads · LSA · SEO/AEO · GBP · Reviews",
        "1D4ED8",
    ),
    (
        "ELITE COACH",
        "$2,600", "$3,497/mo",
        "Weekly coaching · Intake framework · Hiring roadmap",
        "6D28D9",
    ),
]
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $5,500–$7,500/mo paid to Google/Meta"
)

AVG_CASE_VALUE      = "$4,000 (est.)"
CONSERVATIVE_LABEL  = "Conservative  (3–4 cases/mo):"
CONSERVATIVE_RESULT = "~$14,000 revenue · 2.5× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (5–6 cases/mo):"
AGGRESSIVE_RESULT   = "~$24,000 revenue · 3.1× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Google Ads + LSA campaigns launch live"),
    ("Day 14",  "Website conversion updates go live"),
    ("Week 2",  "Review outreach campaign begins"),
    ("Week 3",  "Directory audit + Avvo completed"),
    ("Month 3", "75+ reviews target; LSA fully competitive"),
]

CLOSING_QUOTE = (
    '"When the phone rings because the system is working — '
    'not because you knew the right people — '
    'that is the firm we are building for you."'
)
