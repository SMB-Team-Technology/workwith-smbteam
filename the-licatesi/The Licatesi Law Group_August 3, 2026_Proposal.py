...
# Report metadata
FIRM_NAME      = "The Licatesi Law Group, LLP"
SALES_REP      = "Randy Gold"
OUTPUT_PATH    = "the-licatesi/The Licatesi Law Group_August 3, 2026_Proposal.pptx"
...
PILLARS = [
    ("AMBER", "AMBER", "$100k/mo to a vendor"),      # Lead Generation
    ("AMBER", "AMBER", "No intake visibility"),       # Intake
    ("AMBER", "AMBER", "Vendor needs prompting"),      # Team
    ("AMBER", "AMBER", "Spend vs. cases don't add up"),  # Profit Plan
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "Named competitors outrank Licatesi on its own core local searches"),
    ("neg", "A mid-rebrand split domain and 3 phone numbers fragment the firm's presence"),
    ("neg", "Current vendor \"requires constant prompting\" with no clear ROI"),
    ("pos", "A 4.8-star, 291-review reputation with a $100M+ recovery record"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
# List 3 competitors + the client row is added automatically.
COMPETITORS = [
    ("Palermo Law, P.L.L.C.",          "400+ reviews", "5.0 rating · 9 offices"),
    ("Raphaelson & Levine Law Firm",   "700+ reviews", "4.8 rating · NYC + LI"),
    ("Law Office of Jason Tenenbaum",  "200+ reviews", "4.9 rating · multilingual"),
]
CLIENT_REVIEWS      = "291 reviews"
CLIENT_REVIEWS_NOTE = "← You are here"

# Stage strip (right panel, Slide 1)
STAGE_TEXT = "Stage: ~$60k/mo revenue  →  Goal: $100k/mo revenue"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $100,000/Month"

SMB_MODEL_DESC = (
    "All four pillars must work together — marketing, intake, team, and profit. "
    "Missing any one means growth stalls regardless of ad spend. "
    "When all four pillars work, Michael and Brianna can finally step back from "
    "managing the marketing relationship and trust it runs on its own."
)

GOAL_HEADLINE = "$60k → $100k/mo revenue"
GOAL_DBM      = "A marketing engine that runs without constant prompting"
...
PRIORITIES = [
    (
        ...
        [
            "Consolidate rebrand onto one live domain",
            "Fix NAP data across directories and listings",
            "Win back organic rankings for local searches",
            "Launch Google Search and Local Service Ads",
    ...
    (
        ...
        [
            "Relaunch paused Instagram with new booking link",
            "Build visibility into the full intake process",
            "Confirm after-hours coverage for new leads",
            "Convert more of the cases already being generated",
            "Capture cases without spending another ad dollar",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Remove Michael and Brianna from vendor management",
            "Reconcile ad spend, case volume, and case value",
            "Build weekly coaching cadence with Elite Coach Plus",
            "Establish accountability for growth functions",
            "Turn 'revenue is growing' into money you can count on",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,997", "$5,697/mo",
        "Website & local SEO · Google/LSA · Meta ads · reporting",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
...
CONSERVATIVE_LABEL = "Conservative  (2 cases/mo):"
CONSERVATIVE_RESULT = "$15,000 revenue · 1.5× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (5 cases/mo):"
AGGRESSIVE_RESULT  = "$37,500 revenue · 1.9× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch Google Search & LSA across all 3 office markets"),
    ("Day 14",  "Consolidate site to licatesilaw.com; fix NAP data"),
    ("Week 2",  "Kick off Elite Coach Plus profit-tracking sessions"),
    ("Week 3",  "Relaunch Meta/Instagram once booking link is live"),
    ("Month 3", "Run PageSpeed check ahead of scaling ad spend"),
]

CLOSING_QUOTE = (
    '"You should not have to keep prompting a vendor to protect what you\'ve '
    'built. This is a marketing partnership that runs on its own — so your '
    'time, and Brianna\'s, goes back to running the firm."'
)
