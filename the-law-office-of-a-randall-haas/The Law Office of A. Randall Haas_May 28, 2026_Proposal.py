...
# Report metadata
FIRM_NAME      = "The Law Office of A. Randall Haas"
SALES_REP      = "Jonathan Farace"
OUTPUT_PATH    = "the-law-office-of-a-randall-haas/The Law Office of A. Randall Haas_May 28, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "RED",   "Not in Google 3-pack"),
    ("RED",   "RED",   "Contact form buried"),
    ("RED",   "RED",   "Attorney-dependent op"),
...
FINDINGS = [
    ("neg", "Invisible on Google — no 3-pack presence for any criminal defense keyword in Fort Lauderdale"),
    ("neg", "No after-hours intake: calls at night go to voicemail while competitors pick up"),
    ("neg", "Two confirmed NAP conflicts suppressing local rankings every single day"),
    ("pos", "133 five-star Google reviews and 39 years of experience — a powerful foundation to build on"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Rossen Law Firm",       "338 Google reviews", "Inc. 5000 · 9 offices"),
    ("Robert David Malove",   "215 Avvo reviews",   "41 yrs · Super Lawyers"),
    ("Hager & Schwartz, P.A.", "87 Avvo reviews",   "Multi-atty · top organic"),
]
CLIENT_REVIEWS      = "133 reviews"
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $91,000/Month"

SMB_MODEL_DESC = (
    "Lead generation, intake, a self-managing team, and a profit plan "
    "— all four must work together. When they do, Randall can focus on "
    "the cases he loves while the business runs itself."
)

GOAL_HEADLINE = "$550K → $1.1M revenue"
GOAL_DBM      = "Work the cases you choose — not the ones you chase"
...
PRIORITIES = [
    (
        ...
        [
            "Launch Google Ads for DUI, drug, sex crimes",
            "Activate LSA — Google Screened, top of page",
            "Rebuild site: fast, mobile, homepage form",
            "Fix NAP conflicts to recover local rankings",
    ...
    (
        ...
        [
            "Add homepage form to capture every visitor",
            "Deploy after-hours intake coverage",
            "Build same-day follow-up sequence",
            "Train Gladys to run intake independently",
            "Convert more leads without more ad spend",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Document intake and case onboarding steps",
            "Define Gladys's role and accountability",
            "Track profit by case type — find best work",
            "Build the foundation to grow the team next",
            "Know what you earn, keep, and can grow",
        ],
    ),
]
...
PACKAGES = [
    ...
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "Weekly coaching · Intake build · Masterminds · Workshops",
        "6D28D9",
    ),
]
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $8,700–$19,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE      = "$6,500"
CONSERVATIVE_LABEL  = "Conservative  (~7 cases/mo):"
CONSERVATIVE_RESULT = "$45,500 revenue · 5.2× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (~18 cases/mo):"
AGGRESSIVE_RESULT   = "$117,000 revenue · 6.2× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Google Ads & LSA campaigns go live"),
    ("Day 14",  "Website rebuild begins, new brand domain"),
    ("Week 2",  "NAP conflicts fixed across all directories"),
    ("Week 3",  "Coaching kickoff, Gladys intake training"),
    ("Month 3", "Review program active; 3-pack gains build"),
]

CLOSING_QUOTE = (
    '"39 years of criminal defense excellence — and a system that finally puts that '
    'reputation in front of every Fort Lauderdale prospect who needs it."'
)
