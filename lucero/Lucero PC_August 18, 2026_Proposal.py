...
OUTPUT_PATH    = "lucero/Lucero PC_August 18, 2026_Proposal.pptx"
...
FINDINGS = [
    ("neg", "Unprofitable $5,800/mo PPC produces ~1 client a month"),
    ("neg", "Close rate collapsed from ~30% in July to ~7% in August"),
    ("neg", "Solo attorney handles every case and court date personally"),
    ("pos", "Organic blog already outperforms paid marketing spend"),
]

# Competitor table — list of (name, review note, "brief note")
# Review counts are not independently confirmed via Google in this research
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach 5-6 Cases a Month"

SMB_MODEL_DESC = (
    "Lead Generation, Intake, Team, and Profit have to work together. "
    "When all four do, Christopher can finally step back from being the "
    "only person who can show up in court every day."
)

GOAL_HEADLINE = "2-3 → 5-6 private cases/mo"
GOAL_DBM      = "Christopher isn't the only one who can show up"
...
PRIORITIES = [
    (
        ...
        [
            "Fix the failing $5,800/mo PPC campaign",
            "Launch Local Service Ads for qualified leads",
            "Build geo-pages for Pomona, Claremont, San Dimas",
            "Fix the NAP phone number mismatch",
    ...
    (
        ...
        [
            ...
            "Recover close rate from ~7% back to benchmark",
            "Add a website contact form",
            "Capture leads who won't call first",
            "Convert leads you already paid for — no new spend",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "003A59",
        [
            "Build the associate-hiring plan now",
            "Start coaching to build a delegation structure",
            "Establish a real profit plan, not just case counts",
            "Know the margin needed to fund the hire",
            "Step back from court, and trust it still runs",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,997", "$5,697/mo",
        "Google Ads · LSA · Local SEO/Geo-Pages · Website Fixes",
        "0091C9",
    ),
    (
        "ELITE COACH PLUS",
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $5,500–$8,400/mo paid directly to Google/LSA"
)
...
AGGRESSIVE_RESULT  = "$52,500 revenue · 6.3× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch Google Ads, begin LSA setup"),
    ("Day 14",  "Fix website contact form & NAP mismatch"),
    ("Week 2",  "Kick off Elite Coach Plus coaching sessions"),
    ("Week 3",  "Publish first neighboring-city geo-page"),
    ("Month 3", "Baseline profit tracking tied to case goals"),
]

CLOSING_QUOTE = (
    '"I want a firm that keeps running even on the days '
    'I can\'t be the one in court."'
)
