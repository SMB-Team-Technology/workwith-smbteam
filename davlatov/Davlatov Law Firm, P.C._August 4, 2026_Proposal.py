...
# Report metadata
FIRM_NAME      = "Davlatov Law Firm, P.C."
SALES_REP      = "Nick Holderman"
OUTPUT_PATH    = "davlatov/Davlatov Law Firm, P.C._August 4, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED", "CRITICAL", "Zero PI/FL reach"),
    ("RED", "CRITICAL", "Missed-call leaks"),
    ("RED", "CRITICAL", "Owner-dependent"),
    ("RED", "CRITICAL", "Breakeven + debt"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "Zero search presence in Personal Injury & Family Law pivot areas"),
    ("neg", "Missed calls waste paid marketing spend and lose signed cases"),
    ("neg", "12-hour days, no delegation — Mustafo is the firm's only engine"),
    ("pos", "4.7-star rating across roughly 90-190 Google reviews"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Gursoy Law Firm",       "270+ reviews", "5.0★ · immigration"),
    ("Karasik Law Group",     "60 reviews",   "4.6-4.8★ · PI"),
    ("The Louis Law Firm",    "21-215 rvws",  "5.0★ · family law"),
]
CLIENT_REVIEWS      = "90-190 reviews"
...
SMB_MODEL_DESC = (
    "Lead generation, intake, team, and profit have to work together — "
    "missing one means growth stalls no matter how many new cases come in. "
    "When all four pillars work, Mustafo can finally step away and trust the firm runs."
)
...
PRIORITIES = [
    (
        ...
        [
            "Launch Google Ads for Personal Injury & Family Law",
            "Enroll in Local Service Ads — pay only per lead",
            "Build new Personal Injury & Family Law web pages",
            "Re-engage 2,000+ existing clients for referrals",
    ...
    (
        ...
        [
            "Fix missed calls losing paid-for leads",
            "Build a defined follow-up sequence",
            "Add call tracking to find the leaks",
            "Convert leads already being generated",
    ...
    (
        ...
        [
            "Build first delegation layer with coaching",
            "Launch a real collections push on $1M owed",
            "Create a profit plan beyond breakeven",
            "Free Mustafo from being the only closer",
            "Turn 12-hour days into a real schedule",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,997", "$5,697/mo",
        "Google Ads · Local SEO · LSA · Meta Ads · Web pages",
        "1D4ED8",
    ),
    (
        "ELITE COACH",
        "$2,600", "$3,497/mo",
        "Weekly coaching · Delegation build · Accountability",
        "6D28D9",
    ),
]
...
AVG_CASE_VALUE     = "~$4,400"
CONSERVATIVE_LABEL = "Conservative  (~8 cases/mo):"
CONSERVATIVE_RESULT = "$35,200 revenue · 4.7× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (~25 cases/mo):"
AGGRESSIVE_RESULT  = "$110,000 revenue · 5.5× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch Personal Injury & Family Law ad campaigns"),
    ("Day 14",  "New Personal Injury & Family Law web pages live"),
    ("Week 2",  "Coaching kickoff — build the delegation plan"),
    ("Week 3",  "Retargeting campaign to past clients live"),
    ("Month 3", "Local SEO foundation strengthens rankings"),
]

CLOSING_QUOTE = (
    '"A firm that keeps running the day I decide to take a real vacation."'
)
