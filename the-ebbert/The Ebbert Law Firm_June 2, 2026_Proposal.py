...
# Report metadata
FIRM_NAME      = "The Ebbert Law Firm"
SALES_REP      = "Dan Bryant"
OUTPUT_PATH    = "the-ebbert/The Ebbert Law Firm_June 2, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL",  "Zero paid presence"),    # Lead Generation
    ("RED",   "CRITICAL",  "No intake staff/chat"),   # Intake
    ("RED",   "CRITICAL",  "Solo — no team layer"),   # Team
...
FINDINGS = [
    ("neg", "Zero paid ads across 5 practice areas — every competitor click is a lost case"),
    ("neg", "No LSA presence — competitors with fewer reviews hold the top Google spots"),
    ("neg", "Solo practice with no staff — every lead depends on Eric being personally available"),
    ("pos", "137 Google reviews at 4.9 stars — strongest review profile of any Knoxville competitor"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("The Burkhalter Law Firm",    "95 reviews",  "#1 Employment claim · active SEO"),
    ("Hodges, Doughty & Carson",   "78 reviews",  "90+ yr firm · employment + biz lit"),
    ("Kramer Rayson LLP",          "20 Best Lawyers", "75+ yrs · HOA, employment, biz"),
]
CLIENT_REVIEWS      = "137 reviews · 4.9★"
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Scale Beyond $1M"

SMB_MODEL_DESC = (
    "Lead Generation, Intake, Team, and Profit must all work "
    "together — when one is missing, growth stalls no matter "
    "how many leads come in. For The Ebbert Law Firm, building "
    "all four pillars is what unlocks the ability to step back "
    "and let the firm generate income without depending on "
    "Eric's constant personal presence."
)

GOAL_HEADLINE = "Stage 3 → $1M+ Revenue"
GOAL_DBM      = "A firm that runs — even when you step away"
...
PRIORITIES = [
    (
        ...
        [
            "Launch Google Ads — employment & estate law",
            "Get Google Screened, go live in LSA this week",
            "Turn 4.9/137 reviews into paid-search credibility",
            "Run Meta retargeting for every site visitor",
            "Expand geo-pages across Knox County cities",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Add contact form above the fold on homepage",
            "Set 5-min response standard for all new leads",
            "Install after-hours answering coverage now",
            "Build a lead-tracking log for every inquiry",
            "Move Avvo reviews from 0 to 20+ this quarter",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Define first hire — intake coordinator role",
            "Build ops playbook before the first hire starts",
            "Track revenue and time per practice area monthly",
            "Fix NAP inconsistency on Facebook listing",
            "Set monthly profit targets by case type",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,847", "$5,697/mo",
        "Google Ads · LSA · Local SEO · Web optimization · GBP",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $5,000–$8,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE     = "$3,000 (default — confirm on call)"
CONSERVATIVE_LABEL = "Conservative  (6 cases/mo):"
CONSERVATIVE_RESULT = "$18,000 revenue · 3.6× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (12 cases/mo):"
AGGRESSIVE_RESULT  = "$36,000 revenue · 4.5× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",    "Google Ads go live — employment & estate law"),
    ("Day 14",   "Google Screened submitted; LSA campaigns live"),
    ("Week 2",   "Above-fold lead form added to homepage"),
    ("Week 3",   "First Elite Coach Plus session; intake protocols set"),
    ("Month 3",  "Local SEO cleanup + review transfer to Avvo/FindLaw"),
]

CLOSING_QUOTE = (
    '"Thirty years of reputation — and now a system that turns it '
    'into cases, automatically, every day."'
)
