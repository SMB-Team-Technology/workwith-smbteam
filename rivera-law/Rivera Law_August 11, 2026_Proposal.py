...
# Report metadata
FIRM_NAME      = "Rivera Law"
SALES_REP      = "Jonathan Farace"
OUTPUT_PATH    = "rivera-law/Rivera Law_August 11, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "RED",   "0 of 9 local searches"),
    ("RED",   "RED",   "5 of 20-30 convert"),
    ("AMBER", "AMBER", "Owner is bottleneck"),
    ("AMBER", "AMBER", "Revenue swings 2x"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "Losing 75-83% of paid leads with no trained intake process"),
    ("neg", "Invisible in all 9 local searches across 3 practice areas"),
    ("neg", "Revenue swings $50K-$100K/mo with no predictability"),
    ("pos", "A corroborated 4.7-star rating is already earned — visibility is the missing piece"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Sterling Lawyers, LLC",  "7,000+ reviews", "Family law leader"),
    ("Francis Law Center",     "186+ reviews",   "Immigration leader"),
    ("Gardi Haught Fischer",   "7 reviews",      "Same 3 practice areas"),
]
CLIENT_REVIEWS      = "4.7★ rating"
...
SMB_MODEL_DESC = (
    ...
    "When all four work, Jesus can finally step back from being the "
    "\"Chief Everything Officer\" and build a firm his daughter can inherit."
)

GOAL_HEADLINE = "$1M → $2M-$3M revenue"
GOAL_DBM      = "Build a legacy his daughter can inherit"
...
PRIORITIES = [
    (
        ...
        [
            "Launch Google Ads across all 3 practice areas",
            "Add Local Service Ads for pay-per-lead visibility",
            "Fix NAP across Avvo, Justia, and FindLaw listings",
            "Build a Spanish-language campaign for bilingual clients",
    ...
    (
        ...
        [
            "Add a trained intake process, not you",
            "Build a website contact form that converts 24/7",
            "Create a follow-up sequence for leads who don't sign",
            "Track why 15-25 of 20-30 inquiries don't convert",
            "Stop personally vetting every single lead",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Build a management layer between you and staff",
            "Create delegation so no single hire can break you",
            "Track monthly revenue to end the guesswork",
            "Plan for profit — not just chase revenue",
            "Step back and let the firm run itself",
        ],
    ),
]
...
PACKAGES = [
    ...
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "Weekly group coaching · Intake framework · Workshops",
        "6D28D9",
    ),
]
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $14,000–$18,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE     = "$4,575"
CONSERVATIVE_LABEL = "Conservative  (14 cases/mo):"
CONSERVATIVE_RESULT = "$64,050 revenue · 4.6× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (22 cases/mo):"
AGGRESSIVE_RESULT  = "$100,650 revenue · 5.6× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch Google Ads & LSA across all 3 areas"),
    ("Day 14",  "Website contact form and attorney bio live"),
    ("Week 2",  "NAP cleanup across all directories complete"),
    ("Week 3",  "Elite Coach Plus kickoff — intake process design"),
    ("Month 3", "Follow-up sequence live, first ROI data reviewed"),
]

CLOSING_QUOTE = (
    '"I want to build something my daughter can inherit — '
