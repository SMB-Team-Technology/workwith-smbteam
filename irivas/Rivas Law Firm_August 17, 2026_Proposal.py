...
# Report metadata
FIRM_NAME      = "Rivas Law Firm, PLLC"
SALES_REP      = "Nick Holderman"
OUTPUT_PATH    = "irivas/Rivas Law Firm_August 17, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL", "95% referral only"),
    ("RED",   "CRITICAL", "No CRM, no process"),
    ("RED",   "CRITICAL", "No delegation"),
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $3-4M"

SMB_MODEL_DESC = (
    "Lead Gen, Intake, Team, and Profit must all work together. "
    "When all four pillars work, Israel can finally step away and trust the firm runs."
)

GOAL_HEADLINE = "$1.5-2M → $3-4M revenue"
...
PRIORITIES = [
    ...
    (
        ...
        [
            "Build a defined intake process, no CRM gaps",
            "Add after-hours coverage for new leads",
            "Track every case from click to signed",
            "Fix homepage — add a visible contact form",
            "Stop missing leads before you ever see them",
        ],
    ),
    (
        ...
        [
            ...
            "Free your time from daily casework",
        ],
    ),
]
...
CLOSING_QUOTE = (
    '"I want to double this firm — and finally get my time back."'
)
