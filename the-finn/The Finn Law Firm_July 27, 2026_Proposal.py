...
# Report metadata
FIRM_NAME      = "The Finn Law Firm"
SALES_REP      = "Jacob Meissner"
OUTPUT_PATH    = "the-finn/The Finn Law Firm_July 27, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL", "Ads paused 6 months"),
    ("RED",   "CRITICAL", "No system, no team"),
    ("RED",   "CRITICAL", "Solo — no staff"),
    ("AMBER", "AMBER",    "Cash flow volatile"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "Zero organic visibility across all 9 competitor searches run"),
    ("neg", "Every case evaluated personally by Larry — no intake system exists"),
    ("neg", "No additional attorneys or staff — the entire firm runs through Larry"),
    ("pos", "40+ years experience, Super Lawyers selection, $400K+ average case value"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Malman Law",              "127+ reviews", "TV + landing pages"),
    ("Levin & Perconti",        "600+ reviews", "Med mal + abuse content"),
    ("Rosenfeld Injury Lawyers","600+ reviews", "Clergy abuse ad content"),
]
...
SMB_MODEL_DESC = (
    "Lead generation, intake, team, and profit all have to work together. "
    "When all four pillars work, Larry can finally automate the firm's workflows and stabilize revenue without being the bottleneck."
)

GOAL_HEADLINE = "$1M → $2M+ revenue"
GOAL_DBM      = "Automate workflows, stabilize revenue"
...
PRIORITIES = [
    (
        ...
        [
            "Relaunch Google Ads in all 3 practice areas",
            "Turn Google into a pipeline that runs itself",
            "Launch Local Service Ads for top placement",
            "Rebuild local SEO to close the visibility gap",
            "Add Meta retargeting for lost site visitors",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Automate the pre-intake evaluation bottleneck",
            "Add after-hours lead capture and follow-up",
            "Build a defined intake tracking process",
            "Free Larry from evaluating every case himself",
    ...
    (
        ...
        [
            "Build a self-managing structure before hiring",
            "Add coaching to sequence workflows first",
            "Track profitability by practice area",
            "Resolve cash-flow volatility with a profit plan",
            "Step back and trust the firm still runs",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$7,497", "$8,997/mo",
        "Google Ads · Local SEO · LSA · Meta Ads · GBP optimization",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "Weekly coaching · Workflow & intake automation",
        "6D28D9",
    ),
]
...
AVG_CASE_VALUE     = "$400,000+"
CONSERVATIVE_LABEL = "Conservative  (1 case/mo):"
CONSERVATIVE_RESULT = "$400K revenue · 133× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (4 cases/mo):"
AGGRESSIVE_RESULT  = "$1.6M revenue · 133× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Relaunch Google Ads across all 3 practice areas"),
    ("Day 14",  "Launch Local Service Ads for top-of-page spots"),
    ("Week 2",  "Begin Elite Coach Plus intake automation work"),
    ("Week 3",  "Local SEO & GBP optimization live"),
    ("Month 3", "New lead and intake system fully running"),
]

CLOSING_QUOTE = (
    '"Automate workflows to stabilize revenue and enable expansion, '
    'starting with the bottlenecked pre-intake evaluation process."'
)
