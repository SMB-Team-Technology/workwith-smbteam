...
OUTPUT_PATH    = "albizu-law/Albizu Law_July 21, 2026_Proposal.pptx"
...
COMPETITORS = [
    ("Lincoln-Goldfinch Law", "4,460 reviews", "4.9★ · dominates immigration"),
...
PRIORITIES = [
    (
        ...
        [
            "Fix the four-directory address conflict",
...
TIMELINE = [
    ...
    ("Day 14",  "Fix NAP citations & complete LSA setup"),
