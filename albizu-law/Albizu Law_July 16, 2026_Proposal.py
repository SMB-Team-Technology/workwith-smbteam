...
# Report metadata
FIRM_NAME      = "Albizu Law"
SALES_REP      = "Jonathan Farace"
OUTPUT_PATH    = "albizu-law/Albizu Law_July 16, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL", "No local pack hits"),
    ("RED",   "CRITICAL", "No CRM or follow-up"),
    ("RED",   "CRITICAL", "Iris = 85% of cases"),
...
FINDINGS = [
    ("neg", "Iris absorbs 85% of casework at 70 hrs/week"),
    ("neg", "Zero visibility while rivals dominate every search"),
    ("neg", "No intake process — referral leads go uncontacted"),
    ("pos", "4.7-star rating — a strong foundation to build on"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Lincoln-Goldfinch Law", "1,523 reviews", "4.9★ · dominates immigration"),
    ("Kirker Davis LLP",      "305 reviews",   "4.8★ · dominates family law"),
    ("Alonso & Alonso",       "119 reviews",   "4.9★ · bilingual rival"),
]
CLIENT_REVIEWS      = "~40 reviews"
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $5M-$6M"

SMB_MODEL_DESC = (
    "All four pillars — marketing, intake, team, and profit — must work "
    "together. When they do, Iris can finally step back from 85% of "
    "casework and get her time back."
)

GOAL_HEADLINE = "$1.8M → $5M-$6M revenue"
GOAL_DBM      = "Iris gets her 40-hour week back"
...
PRIORITIES = [
    (
        ...
        [
            "Fix the LawInfo address conflict fast",
            "Reactivate the family law ad landing page",
            "Launch immigration Google Search + LSA ads",
            "Add Spanish-language campaigns to stand out",
            "Turn visibility into a pipeline that runs itself",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Add an embedded homepage contact form",
            "Build a defined lead follow-up sequence",
            "Track every lead from click to signed case",
            "Stop losing referrals to slow response",
            "Free Iris from chasing every inquiry herself",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Launch a 90-day bilingual hiring sprint",
            "Delegate casework to new attorneys & paralegals",
            "Track cost-per-case and margin by practice area",
            "Build coaching-backed leadership structure",
            "Give Iris her nights and weekends back",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$7,397", "$8,997/mo",
        "Google Ads · LSA · Meta Ads · Local SEO · GBP fixes",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "Weekly coaching · Hiring plan · Delegation systems",
        "6D28D9",
    ),
]
...
AGGRESSIVE_RESULT  = "$106,250 revenue · 7.6× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch Growth marketing across both practice areas"),
    ("Day 14",  "Fix LawInfo citation & complete LSA setup"),
    ("Week 2",  "Add homepage contact form to cut intake friction"),
    ("Week 3",  "Kick off Elite Coach Plus & hiring sprint"),
    ("Month 3", "Cost-per-case tracking live across the firm"),
]

CLOSING_QUOTE = (
    '"I just want a sustainable 40-hour week — and to be there for my '
