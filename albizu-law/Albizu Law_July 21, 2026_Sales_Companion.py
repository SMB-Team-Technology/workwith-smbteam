...
OUTPUT_PATH = "albizu-law/Albizu Law_July 21, 2026_Sales_Companion.pdf"
...
story.append(Paragraph("Sales Companion  |  July 21, 2026  |  Rep: Jonathan Farace", S["subtitle"]))
...
story.append(b("Existing family law landing page and 16 geo-targeted city pages are underused assets this package activates."))
story.append(b("Four-directory NAP conflict is actively suppressing local rankings and is corrected as part of this package."))
...
story.append(Paragraph("True, but every one of the 6 competitor searches performed put Lincoln-Goldfinch Law (4,460 reviews, Birdeye-aggregated), Kirker Davis LLP (305 reviews), or Alonso & Alonso ahead of Albizu Law's ~40. Referrals got the firm to $1.8M; they will not get it to $5M-$6M against that visibility gap.", S["objection_a"]))
