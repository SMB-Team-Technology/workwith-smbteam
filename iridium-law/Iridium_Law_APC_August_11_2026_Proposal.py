...
# Report metadata
FIRM_NAME      = "Iridium Law APC"
SALES_REP      = "Jonathan Farace"
OUTPUT_PATH    = "iridium-law/Iridium_Law_APC_August_11_2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL", "No verified GBP yet"),
    ("AMBER", "AMBER",    "No lead screening"),
    ("RED",   "CRITICAL", "Solo attorney only"),
...
FINDINGS = [
    ("neg", "No verified Google Business Profile — invisible to local search"),
    ("neg", "Word-of-mouth and discounted ARAG referrals are the only leads"),
    ("neg", "Hadeel is the firm's only attorney — nothing runs without her"),
    ("pos", "Already tracks profit precisely — $30K/mo, up from $10-15K/mo"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Radcliffe & Radcliffe",       "39 reviews", "30+ yrs · Pleasant Hill"),
    ("Bay Area Family Law Center",  "26 reviews", "10/10 Super Lawyers"),
    ("Pocklington Law Offices",     "17 reviews", "2026 Avvo Client's Choice"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $125,000/Month"

SMB_MODEL_DESC = (
    "All four pillars — lead generation, intake, team, and profit — have to work "
    "together. Missing one means growth stays a rollercoaster no matter how many "
    "referrals come in. When all four click, Hadeel can finally step back from "
    "being the workhorse and be present for her daughter."
)

GOAL_HEADLINE = "$390K → $1.5M revenue"
...
PRIORITIES = [
    (
        ...
        [
            ...
            "Launch PPC + Meta ads for family law",
            "Clean up directory listings (NAP)",
            "Capture searches before competitors bid",
    ...
    (
        ...
        [
            "Add a client-qualification step",
            "Screen out cases that won't convert",
            "Protect attorney time as leads grow",
            "Turn automation into real conversions",
            "Free your calendar from unqualified calls",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Start Elite Coach weekly accountability",
            "Document processes you carry alone",
            "Build a path to your first associate",
            "Track true profit by lead source",
            "Build a firm that runs without you in it",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$3,497", "$3,797/mo",
        "GBP · PPC · Meta Retargeting · Directory cleanup",
        "1D4ED8",
    ),
    (
        "ELITE COACH",
        "$2,600", "$3,497/mo",
        "Weekly coaching · SOPs · Hiring roadmap",
        "6D28D9",
    ),
]
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $4,700–$5,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE     = "$35,000–$40,000"
CONSERVATIVE_LABEL = "Conservative  (6-7 cases/mo):"
CONSERVATIVE_RESULT = "$225,000 revenue · 48× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (8 cases/mo):"
AGGRESSIVE_RESULT  = "$300,000 revenue · 60× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch PPC + Meta Retargeting for family law"),
    ("Day 14",  "GBP verification & directory NAP cleanup done"),
    ("Week 2",  "Website review & content buildout begins"),
    ("Week 3",  "Elite Coach kickoff — weekly accountability starts"),
    ("Month 3", "Client-qualification step live in intake"),
]

CLOSING_QUOTE = (
    '"A well-oiled machine, with me as the owner — not the workhorse — '
    'home for my daughter every night."'
)
