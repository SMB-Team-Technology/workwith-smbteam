...
# Report metadata
FIRM_NAME      = "The Bradley Law Firm, PLLC"
SALES_REP      = "Dan Bryant"
OUTPUT_PATH    = "bradley-law/BradleyLaw_June192026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL",    "No paid ads running"),
    ("AMBER", "IN PROGRESS", "AI calls captured"),
    ("RED",   "CRITICAL",    "2-person team, gaps"),
    ("AMBER", "IN PROGRESS", "Revenue not tracked"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "No paid ads — every online estate planning prospect goes to a competitor"),
    ("neg", "3.9 stars vs. Burdette's 4.6/5.0 — clients choose the higher-rated firm"),
    ("neg", "Solo atty + part-time paralegal with quality issues — can't grow without growing hours"),
    ("pos", "136 Google reviews — highest verified count among all local competitors"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("The Burdette Law Firm",  "41 reviews · 4.6 ★", "5.0 at Germantown loc."),
    ("Snider & Horner, PLLC",  "38 reviews · 3.7 ★", "Geo landing pages built"),
    ("Patterson Bray PLLC",    "AV Preeminent",            "4 Super Lawyers attys"),
]
CLIENT_REVIEWS      = "136 reviews · 3.9 ★"
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Build a Self-Running Firm"

SMB_MODEL_DESC = (
    "Lead Generation, Intake, Team, and Profit must all work together. "
    "Fix one without the others and growth stalls. "
    "When all four work for Anthony, he earns more by working smarter — "
    "not just by working more."
)

GOAL_HEADLINE = "Work smarter, not harder"
GOAL_DBM      = "Earn more without more hours"
...
PRIORITIES = [
    (
        ...
        [
            ...
            "LSA: pay only when a real prospect calls",
            "Build geo pages Snider & Horner already has",
            "Fix NAP issues suppressing map pack rank",
            "Retargeting: every site visitor sees you again",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Automate VA/elder law document follow-up",
            "Build signing logistics for non-local clients",
            "Define follow-up for leads who don't sign same day",
            "Reduce cycle time — more closings per month",
            "Convert more of the leads you already generate",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Hire a full-time client services coordinator",
            "Eliminate duplicate entry between case systems",
            "Track revenue and profit by practice area",
            "Build SOPs Anthony can delegate and trust",
            "Know your numbers — earn and keep more",
        ],
    ),
]
...
CONSERVATIVE_RESULT = "~$10,500 revenue  ·  ~3× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (14–16 cases/mo):"
AGGRESSIVE_RESULT  = "~$56,000 revenue  ·  ~4× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Google Ads & LSA campaigns go live"),
    ("Day 14",  "Website rebuild — Germantown landing pages"),
    ("Week 2",  "NAP audit — fix phone/address inconsistencies"),
    ("Week 3",  "Coaching kickoff — set targets & intake design"),
    ("Month 3", "PracticePanther/WealthCounsel workflow audit"),
]

CLOSING_QUOTE = (
    "“Earn more this year than last — not by raising prices, not by working more, "
    "but by finally having a firm that works as hard as you do.”"
)
