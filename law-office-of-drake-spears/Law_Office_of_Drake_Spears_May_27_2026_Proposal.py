"""
Audit PowerPoint — Law Office of Drake Spears
...
# Report metadata
FIRM_NAME   = "Law Office of Drake Spears"
SALES_REP   = "Jacob Meissner"
OUTPUT_PATH = "law-office-of-drake-spears/Law_Office_of_Drake_Spears_May_27_2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL",  "0 reviews, no 3-pack"),
    ("RED",   "CRITICAL",  "No system in place"),
    ("RED",   "CRITICAL",  "Fully solo, 1 person"),
    ("RED",   "CRITICAL",  "No P&L tracking yet"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "Not in Google 3-pack for any Plainfield family law search"),
    ("neg", "Zero paid ads — O'Dell, Renner & Banks & Brower hold every channel"),
    ("neg", "Solo intake only — no after-hours coverage, no follow-up system"),
    ("pos", "Clean digital slate — strong credentials, new site, no legacy issues"),
]

COMPETITORS = [
    ("O'Dell Family Law",  "16 reviews", "4.8★ · Same Plainfield market"),
    ("Renner Law Office",  "23 reviews", "5.0★ · SEO into Drake's territory"),
    ("Banks & Brower LLC", "893 reviews","4.9★ · Drake's former employer"),
]
CLIENT_REVIEWS      = "~0–3 reviews"
CLIENT_REVIEWS_NOTE = "← You are here"

STAGE_TEXT = "Stage 3: Solo Practitioner  →  Goal: Stage 6, Law Firm Owner"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Build Your Own Practice"

SMB_MODEL_DESC = (
    "Lead Generation, Intake, Team, and Profit must all work together — "
    "missing any one stalls the others. When all four run, "
    "Drake can build a client base that belongs entirely to him."
)

GOAL_HEADLINE = "$250K est. → $500K+ revenue"
GOAL_DBM      = "Build the firm you left your last job to create"

PRIORITIES = [
    (
        "Build the", "Marketing Engine", "1D4ED8",
        [
            "Turn Google into a pipeline — no referrals needed",
            "Launch family law PPC ads for Plainfield & Hendricks Co.",
            "Get Google Screened — appear above every other result",
            "Build 15+ reviews to claim local 3-pack visibility",
            "Fix NAP errors — stop traffic routing to Banks & Brower",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "After-hours response — capture every crisis-moment caller",
            "Intake script to qualify and convert every inquiry",
            "Follow-up sequence for prospects who don't sign same day",
            "Track every lead — know your actual close rate",
            "Web contact form → consultation funnel, no gaps",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Set retainer pricing benchmarks by case type now",
            "Launch financial tracking from the very first month",
            "Plan first hire — free Drake for billable case work",
            "Build profit baseline before rapid growth arrives",
            "Coaching: run the firm like a CEO, not just a lawyer",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$3,397", "No stand-alone",
        "Website · Google Ads · LSA · GBP Optimization · Local SEO",
        "1D4ED8",
    ),
    (
        "ELITE COACH",
        "$2,600", "$3,497/mo",
        "Group coaching · Practice masterminds · Quarterly workshops",
        "6D28D9",
    ),
]
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $5,500–$6,500/mo paid directly to Google / LSA / Meta"
)

AVG_CASE_VALUE      = "~$4,000 (est.)"
CONSERVATIVE_LABEL  = "Conservative  (7–8 cases/mo):"
CONSERVATIVE_RESULT = "~$30,000 revenue · 5.5× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (10–11 cases/mo):"
AGGRESSIVE_RESULT   = "~$42,000 revenue · 6.5× ROAS"

TIMELINE = [
    ("Day 1",    "Kickoff call + Google Ads campaigns go live"),
    ("Day 14",   "Website optimization + LSA verification begins"),
    ("Week 2",   "Review generation campaign activated"),
    ("Week 3",   "NAP fixes + GBP optimization complete"),
    ("Month 3",  "15+ reviews · local 3-pack visibility begins"),
]

CLOSING_QUOTE = (
    '"The system to put your name first in Plainfield doesn\'t exist yet — '
    'every month without it is a case that went to O\'Dell or Renner instead."'
)
