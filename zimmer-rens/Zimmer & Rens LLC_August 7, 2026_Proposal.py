...
# Report metadata
FIRM_NAME      = "Zimmer & Rens LLC"
SALES_REP      = "Jacob Meissner"
OUTPUT_PATH    = "zimmer-rens/Zimmer & Rens LLC_August 7, 2026_Proposal.pptx"
...
PILLARS = [
    ("AMBER", "AMBER", "No paid lead system"),
    ("AMBER", "AMBER", "No after-hours cover"),
    ("AMBER", "AMBER", "4 new areas, same team"),
    ("AMBER", "AMBER", "Spend below benchmark"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "No after-hours coverage loses CD and PI leads nightly"),
    ("neg", "Zero paid presence yet in criminal defense or estate planning"),
    ("neg", "Marketing spend confirmed below 20% benchmark by the firm's own CFO"),
    ("pos", "16-person team and a fractional CFO already in place"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Grieve Law",        "109 reviews",   "5.0★ · Criminal Defense"),
    ("Margerie Law LLC",  "73-99 reviews", "4.9★ · Estate Planning"),
    ("Sterling Lawyers",  "60 reviews",    "4.76★ · Family Law"),
]
CLIENT_REVIEWS      = "Unverified"
CLIENT_REVIEWS_NOTE = "← Live count TBD"

# Stage strip (right panel, Slide 1)
STAGE_TEXT = "Stage 4: Small Business Manager  →  Goal: Stage 6, Law Firm Owner"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Open La Crosse Strong"

SMB_MODEL_DESC = (
    "Marketing, intake, team, and profit systems have to work together. "
    "When all four run, Paul and Taylor can lead a two-office platform "
    "instead of personally carrying every new practice area themselves."
)

GOAL_HEADLINE = "Est. $1.8M → $3.6M revenue"
GOAL_DBM      = "Lead a platform, not every practice area alone"
...
PRIORITIES = [
    (
        ...
        [
            "Launch Google Ads for Criminal Defense",
            "Launch Google Ads for Estate Planning",
            "Claim Local Service Ads across the market",
            "Turn Google into a pipeline that runs itself",
            "Build La Crosse geo-pages before opening day",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Add after-hours coverage for CD and PI calls",
            "Build a defined lead-conversion process",
            "Stop losing nights-and-weekends callers",
            "Speed the queue-to-paralegal handoff",
    ...
    (
        ...
        [
            ...
            "Build reporting so La Crosse scales on purpose",
        ],
    ),
]
...
AVG_CASE_VALUE      = "$2,250–$4,000"
CONSERVATIVE_LABEL  = "Conservative  (27 cases/mo):"
CONSERVATIVE_RESULT = "$83,000 revenue · 3.5× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (52 cases/mo):"
AGGRESSIVE_RESULT   = "$158,000 revenue · 4.3× ROAS"
...
CLOSING_QUOTE = (
    '"Estate planning, criminal defense, PI, and a second office in '
    'La Crosse — running as one platform, not four separate jobs."'
)
