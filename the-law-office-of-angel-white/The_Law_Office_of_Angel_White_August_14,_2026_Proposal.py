...
# Report metadata
FIRM_NAME      = "The Law Office of Angel White"
SALES_REP      = "Jacob Meissner"
OUTPUT_PATH    = "the-law-office-of-angel-white/The_Law_Office_of_Angel_White_August_14,_2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "RED",   "No owned lead gen"),
    ("RED",   "RED",   "Phone-only CTA"),
    ("AMBER", "AMBER", "Solo runs 2 offices"),
...
FINDINGS = [
    ("neg", "Every visitor who won't call leaves with no way to reach the firm"),
    ("neg", "3 named competitors out-review the firm 39-178 vs. 24, and Alabama has zero visibility"),
    ("neg", "With no team beyond Angel, growth to $500K just means more personal load"),
    ("pos", "A 5.0 rating already outranks all 3 named local competitors' star ratings"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Don F. DeFoor, PC",         "178 reviews", "35+ yrs incumbency"),
    ("Scott K. Camp & Assoc.",    "113 reviews", "SEO-built EP pages"),
    ("SR Law Group",              "39 reviews",  "4.9★ boutique brand"),
]
CLIENT_REVIEWS      = "24 reviews"
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $500K"

SMB_MODEL_DESC = (
    "Lead generation, intake, team, and profit work together as one system. "
    "When all four are firing, Angel can finally step away from day-to-day "
    "operations and lead as CEO."
)
...
PRIORITIES = [
    (
        ...
        [
            "Launch Google PPC & LSA for Estate Planning, Probate",
            "Claim Alabama's market before a competitor can",
            "Add geo pages for Villa Rica, Carrollton, Austell",
            "Replace pay-per-lead vendors with an owned channel",
    ...
    (
        ...
        [
            ...
            "Give after-hours visitors a way to reach you",
            "Build a defined follow-up process for new leads",
            "Capture leads the site already attracts, free",
            "Stop losing leads before they reach your desk",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "003A59",
        [
            "Build your first delegation plan for intake",
            "Add leadership support as Alabama scales",
            "Track cost per acquisition by lead source",
            "Get real margin visibility across both offices",
            "Turn growth into profit, not just more work",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,997", "$5,697/mo",
        "Website · SEO · LSA · Google PPC · Social — covers GA & AL",
        "0091C9",
    ),
    (
        "ELITE COACH",
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $5,500–$13,500/mo paid directly to Google/LSA"
)

AVG_CASE_VALUE      = "$2,250"
CONSERVATIVE_LABEL  = "Conservative  (6 cases/mo):"
CONSERVATIVE_RESULT = "$14,175 revenue · 2.6× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (18 cases/mo):"
AGGRESSIVE_RESULT   = "$41,625 revenue · 3.1× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch PPC & LSA campaigns for the GA market"),
    ("Day 14",  "Stand up Alabama's Google Business Profile"),
    ("Week 2",  "Move the contact form above the fold"),
    ("Week 3",  "Kick off Elite Coach delegation plan"),
    ("Month 3", "Launch geo pages for nearby cities"),
]

CLOSING_QUOTE = (
    '"I want to transition from daily operations to a CEO role — '
    'and finally get my work-life balance back."'
)
