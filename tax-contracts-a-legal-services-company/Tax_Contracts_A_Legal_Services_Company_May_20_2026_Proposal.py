"""
Audit PowerPoint — Tax & Contracts, A Legal Services Company
...
FIRM_NAME   = "Tax & Contracts, A Legal Services Company"
SALES_REP   = "Randy Gold"
OUTPUT_PATH = "tax-contracts-a-legal-services-company/Tax_Contracts_A_Legal_Services_Company_May_20_2026_Proposal.pptx"
...
# (status, label, one-line detail ≤20 chars)
PILLARS = [
    ("RED",   "CRITICAL", "No 3-pack / no GBP"),
    ("RED",   "CRITICAL", "57 leads, 1 booking"),
    ("AMBER", "AMBER",    "Team at capacity"),
    ("AMBER", "AMBER",    "No ad attribution"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "57 paid ad leads yielded only 1 booking — intake is broken"),
    ("neg", "GBP not listed under new brand; firm invisible in local search"),
    ("neg", "3–4 agencies active with no attribution or measurable ROI"),
    ("pos", "Webinars close at 80%; referrals close at nearly 100%"),
]

COMPETITORS = [
    ("Gordon Law Group",    "200+ reviews", "4.8–4.9 stars · tax leader"),
    ("The Tax Defenders",   "280 reviews",  "BBB A+ · former IRS Counsel"),
    ("Motiva Business Law", "Active ads",   "business law + formation"),
]
CLIENT_REVIEWS      = "0 confirmed reviews"
CLIENT_REVIEWS_NOTE = "GBP under legacy name"

STAGE_TEXT = "Stage 4: Small Business Manager  →  Goal: Stage 6, Law Firm Owner"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $6M"

SMB_MODEL_DESC = (
    "Lead Generation, Intake, Team, and Profit — all four pillars must "
    "work together. When they do, Chrystan can step back from the "
    "day-to-day and let a firm she built run without her."
)

GOAL_HEADLINE = "Today → $6M in 3 years"
...
PRIORITIES = [
    (
        ...
        [
            "Fix GBP under Tax & Contracts brand",
            "Launch Google Ads for tax & business law",
            "Build a website that converts paid traffic",
            "Add Spanish campaigns for Chicago clients",
            "Earn 50+ Google reviews; enter the 3-pack",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Build 5-step follow-up for paid ad leads",
            "Move from 1.75% to 10%+ lead conversion",
            "Delegate intake from attorney to ops team",
            "Unify lead tracking across all channels",
            "Turn paid leads into clients without more hrs",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Track cost-per-client by channel and agency",
            "End unaccountable agency spend; keep what works",
            "Document SOPs and clear role ownership",
            "Weekly coaching: build the $6M roadmap",
            "Build profit model before revenue outpaces margin",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,847", "$5,697/mo",
        "Website · Google Ads · SEO · GBP · Spanish campaigns",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $3,200–$6,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE      = "$5,000"
CONSERVATIVE_LABEL  = "Conservative  (2–3 cases/mo):"
CONSERVATIVE_RESULT = "$12,500 revenue · 3.9× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (5–6 cases/mo):"
AGGRESSIVE_RESULT   = "$27,500 revenue · 4.6× ROAS"

TIMELINE = [
    ("Day 1",   "Google Ads live for tax & business law"),
    ("Day 14",  "GBP claimed under Tax & Contracts brand"),
    ("Week 2",  "Website rebuild underway; intake sequence built"),
    ("Week 3",  "Coaching kickoff: attribution framework set"),
    ("Month 3", "Review campaign driving local 3-pack entry"),
]

CLOSING_QUOTE = (
    '"I want a $6 million firm I can step back from — '
    'where leads come in, clients are served, and it all runs without me."'
)
