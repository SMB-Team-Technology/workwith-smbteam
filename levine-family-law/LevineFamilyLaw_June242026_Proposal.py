...
# Report metadata
FIRM_NAME      = "Levine Family Law"
SALES_REP      = "Dan Bryant"
OUTPUT_PATH    = "levine-family-law/LevineFamilyLaw_June242026_Proposal.pptx"
...
PILLARS = [
    ...
    ("AMBER", "AMBER",    "No answering service"),
    ("RED",   "CRITICAL", "Zero staff, solo only"),
...
FINDINGS = [
    ("neg", "34 reviews vs. 319 and 1,000+ — invisible in the 3-pack"),
    ("neg", "Google Ads at $800/mo: 5–10 clicks/day in a $90–$180/click market"),
    ("neg", "No answering service — every missed call is a $15K case lost"),
    ("pos", "4.9 stars across 34 reviews — exceptional client satisfaction"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Carmen G. Soto, PA",           "319 reviews",    "4.6★ · 3-pack dominant"),
    ("FL Probate & Family Law Firm", "1,000+ reviews", "5.0★ · owns Maps pack"),
    ("Fort Lauderdale PPC Market",   "$5K–$15K+/mo", "outbidding every click"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $60,000/Month"

SMB_MODEL_DESC = (
    "Lead Generation, Intake, Team, and Profit must all work together — "
    "miss any one and growth stalls. When all four pillars fire, Scott stops "
    "being the single point of failure and starts building the firm he has planned."
)

GOAL_HEADLINE = "$360K → $720K revenue"
...
PRIORITIES = [
    (
        ...
        [
            "Fund Google Ads to $3,500/mo — real lead volume",
            "Enroll in LSA — pay per call, not per click",
            "Build to 75–100 reviews to own the 3-pack",
            "Fix NAP mismatch — unblock your GBP ranking",
    ...
    (
        ...
        [
            "Never miss a call again — 24/7 answering service",
            "Build intake script — qualify every lead on call 1",
            "Add booking link so warm leads don’t go cold",
            "Track cost per call and cost per signed case",
            "Add chat widget for prospects not ready to call",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Build paralegal role — hire before you need to",
            "Set $5,000 retainer floor and hold it",
            "Launch monthly dashboard: revenue by source",
            "Free your evenings — delegation starts with hire 1",
            "Track which cases generate the highest value",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$3,397", "",
        "Google Ads · LSA · SEO · Review Gen · Meta · GBP",
        "1D4ED8",
    ),
    (
        "ELITE COACH",
        "$2,600", "$3,497/mo",
        "Weekly coaching · Intake framework · First-hire planning",
        "6D28D9",
    ),
]
...
AGGRESSIVE_RESULT  = "$195,000 revenue · 26× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",  "Google Ads + LSA application launched"),
    ("Day 14", "Answering service live — 24/7 coverage"),
    ("Day 30", "NAP fix complete; review workflow running"),
    ("Day 60", "75+ reviews building; 3-pack visibility climbing"),
    ("Day 90", "Paralegal role built; expansion planning starts"),
]

CLOSING_QUOTE = (
    '"The credentials, the reputation, and the client satisfaction are already there — '
    'what is missing is the lead engine and the intake system to turn 29 years of '
    'excellence into a pipeline Scott can count on every single month."'
)
