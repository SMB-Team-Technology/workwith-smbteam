...
Output: alpha-center-for-divorce-mediation/Alpha_Center_for_Divorce_Mediation_May262026_Proposal.pptx
"""
...
# Report metadata
FIRM_NAME      = "Alpha Center for Divorce Mediation"
SALES_REP      = "Jacob Meissner"
OUTPUT_PATH    = "alpha-center-for-divorce-mediation/Alpha_Center_for_Divorce_Mediation_May262026_Proposal.pptx"
...
PILLARS = [
    ("AMBER", "AMBER", "LSA + Meta untapped"),
    ("AMBER", "AMBER", "Form buried, no live chat"),
    ("AMBER", "AMBER", "No ops layer (4 offices)"),
    ("AMBER", "AMBER", "No cost-per-case data"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "4.3 stars vs. SnapDivorce 4.8 — same ZIP, losing the first comparison"),
    ("neg", "LSA untapped — top-of-page leads ceded despite BBB A+ eligibility"),
    ("neg", "Contact form on separate page — paid traffic hitting extra friction"),
    ("pos", "57+ geo-targeted pages + active PPC call-tracking infrastructure"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("SnapDivorce LLC",             "22 reviews", "4.8 stars · same Doylestown ZIP"),
    ("Rubin, Glickman, Steinberg",  "69 reviews", "4.8 stars · active April 2026"),
    ("Equitable Mediation",         "Not confirmed", "active in PA mediation searches"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $1.8M Revenue"

SMB_MODEL_DESC = (
    "Lead Generation, Intake, a Self-Managing Team, and a Profit Plan "
    "all have to work together. "
    "When all four pillars are in sync, Keila can step back from the "
    "operations and focus on what she built Alpha Center to do."
)
...
PRIORITIES = [
    (
        ...
        [
            "Activate LSA — BBB A+ earns Google Screened today",
            "Turn Google Ads into a mediation-specific pipeline",
            "Launch Meta retargeting for warm website visitors",
            "Generate 5-10 new reviews/month across all offices",
            "Fix Martindale address — remove local SEO suppressor",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Embed contact form on homepage — one fewer click",
            "Add after-hours coverage — win the urgent call",
            "Build follow-up for leads who don't book same-day",
            "Align PPC landing pages for mediation intent",
            "Track leads from website click to booked call",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Build KPI scorecards per office — see what works",
            "Define role ownership for 14+ staff, 4 offices",
            "Track cost-per-case by service type",
            "Build profit visibility by office and service line",
            "Create the ops layer that lets Keila step back",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,847", "$5,697/mo",
        "Google Ads · LSA · Meta Ads · Local SEO · Website CRO",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $7,000–$17,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE      = "$3,500"
CONSERVATIVE_LABEL  = "Conservative  (10–11 cases/mo):"
CONSERVATIVE_RESULT = "~$38,500 revenue  ·  ~5.0x ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (28–31 cases/mo):"
AGGRESSIVE_RESULT   = "~$105,000 revenue  ·  ~6.2x ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Coaching kickoff + ads account onboarding"),
    ("Day 14",  "Google Ads optimized + LSA application submitted"),
    ("Week 2",  "Homepage form live + review campaign launched"),
    ("Week 3",  "Meta retargeting live + NAP audit complete"),
    ("Month 3", "Star rating climbing + first LSA leads arriving"),
]

CLOSING_QUOTE = (
    '"The reputation is earned and the team is in place — what is missing is the system '
    'to turn 30 years of credibility into a firm that grows and runs on its own."'
)
