...
OUTPUT_PATH    = "the-ladd-firm/The Ladd Firm, LLC_July 23, 2026_Proposal.pptx"
...
PILLARS = [
    ("AMBER", "AMBER",    "No unified ad plan"),
    ("RED",   "CRITICAL", "5 of 10 meetings/wk"),
    ("AMBER", "AMBER",    "Owner: 5 hrs/day"),
...
FINDINGS = [
    ("neg", "No defined intake process — meetings stuck near 5/week vs. a 10 goal"),
    ("neg", "One contractor runs website, SEO, PPC, and LSA with no backup"),
    ("neg", "Southern Estate Lawyers already holds the satellite markets you want"),
    ("pos", "165-209 reviews at 4.9 stars — more than every named competitor"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Southern Estate Lawyers", "60 reviews",  "5.0 · multi-location"),
    ("Holt & Associates",       "N/A",         "City + practice ad pages"),
    ("Johnstone Adams LLC",     "21 reviews",  "125+ yr legacy brand"),
]
CLIENT_REVIEWS      = "165-209 reviews"
...
SMB_MODEL_DESC = (
    ...
    "When they do, Banks can finally step back from production work and trust the firm to run itself."
)
...
PRIORITIES = [
    (
        ...
        [
            "Coordinate PPC, LSA & SEO into one plan",
            "Fix NAP mismatch across directories",
            "Turn Google into leads that don't need you",
            "Put your review lead into ad copy",
            "Target satellite markets before rivals",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Build a real design-meeting follow-up",
            "Move contact form above the fold",
            "Add live chat for after-hours visitors",
            "Close the gap from 5 to 10 meetings/wk",
            "Capture leads you already paid for",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Back up Colin with an internal system",
            "Coach Banks on delegation, not overload",
            "Track profit, not just revenue pace",
            "Raise case value toward market rate",
            "Free up your five hours a day",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,847", "$5,697/mo",
        "PPC · LSA · Local SEO · Directory Cleanup",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "Weekly coaching · Intake framework · Team accountability",
        "6D28D9",
    ),
]
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $3,500–$14,000/mo paid directly to Google/LSA"
)

AVG_CASE_VALUE     = "$4,000"
CONSERVATIVE_LABEL = "Conservative  (3-4 cases/mo):"
CONSERVATIVE_RESULT = "$12K-$16K revenue · ~4.6× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (18-20 cases/mo):"
AGGRESSIVE_RESULT  = "$72K-$80K revenue · ~5.5× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch coordinated PPC + LSA plan"),
    ("Day 14",  "Correct NAP across all directories"),
    ("Week 2",  "Rebuild above-the-fold contact form"),
    ("Week 3",  "Kick off coaching on intake process"),
    ("Month 3", "Baseline profit plan by practice area"),
]

CLOSING_QUOTE = (
    '"You\'ve already built the reputation and the reach — now the firm can run '
    'without needing five hours a day of you to hold it up."'
)
