...
# Report metadata
FIRM_NAME      = "The Ladd Firm, LLC"
SALES_REP      = "Dan Bryant"
OUTPUT_PATH    = "the-ladd-firm/The Ladd Firm, LLC_July 27, 2026_Proposal.pptx"
...
PILLARS = [
    ("AMBER", "AMBER", "$6K/mo, no synergy"),      # Lead Generation
    ("RED",   "RED",   "5 of 10 meetings/wk"),     # Intake
    ("AMBER", "AMBER", "Owner-dependent"),          # Team
    ("AMBER", "AMBER", "No profit plan"),           # Profit Plan
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "Booking 5 of 10 goal design meetings — no defined follow-up process"),
    ("neg", "One contractor runs website, SEO, PPC & LSA — a capacity ceiling"),
    ("neg", "$4,000 avg case value sits below the $5,000 local market rate"),
    ("pos", "165 reviews at 4.9 stars — beats every named local competitor"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Southern Estate Lawyers", "60 reviews", "Multi-location · Foley/Daphne"),
    ("Cromwell & Associates",   "33 reviews", "4.2 stars"),
    ("Johnstone Adams LLC",     "21 reviews", "125+ yr legacy brand"),
]
CLIENT_REVIEWS      = "165 reviews"
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach 10 Meetings a Week"

SMB_MODEL_DESC = (
    "AI-powered workflows and structured coaching work together to free up "
    "an owner's time. When automation handles repeatable tasks and coaching "
    "builds real delegation, Banks can finally step back from five hours of "
    "daily production."
)

GOAL_HEADLINE = "5 → 10 design meetings/week"
GOAL_DBM      = "Banks gets his five hours a day back"

# Each priority: (line1, line2, accent_color_hex, [5 bullet strings])
PRIORITIES = [
    (
        "Automate the", "Busywork", "1D4ED8",
        [
            "Kick off AI Foundation Sprint & CTO L1",
            "Deploy Claude workspace + Legal AI Skills",
            "Connect automations to existing MyCase",
            "Free up hours spent on repeatable tasks",
            "Turn the AI trial into a CTO-led rollout",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Build a defined design-meeting follow-up process",
            "Close the gap from 5 to 10 meetings a week",
            "Add a lower-commitment way to engage the site",
            "Capture leads the firm already paid for",
            "Meetings book without Banks chasing them",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Build a delegation plan for Summer & Leo",
            "Coach Banks out of daily production work",
            "Track profit by practice area, not just pace",
            "Close the $4K vs. $5K case value gap",
            "Turn revenue pace into a real profit plan",
        ],
    ),
]
...
PACKAGES = [
    (
        "LEGAL AI WORKFORCE — FRACTIONAL CTO L1",
        "$3,297", "$3,797/mo",
        "Dedicated CTO · Claude Enterprise · AI Skills · MyCase workflows",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "1:1 coaching · Intake framework · Team accountability",
        "6D28D9",
    ),
]
...
AD_SPEND_NOTE = (
    "+ One-time AI Foundation Sprint: $14,997 (paired w/ CTO L1, not monthly)"
)

AVG_CASE_VALUE     = "$4,000 (below $5K market rate)"
CONSERVATIVE_LABEL = "Current ad spend (self-managed):"
CONSERVATIVE_RESULT = "$6,000/mo → ~$60,000/mo · ~10x"
AGGRESSIVE_LABEL   = "Ad spend & marketing:"
AGGRESSIVE_RESULT  = "Not part of this proposal"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Kick off AI Foundation Sprint & CTO L1"),
    ("Day 14",  "Claude workspace + AI Skills deployed"),
    ("Week 2",  "Elite Coach Plus coaching kickoff"),
    ("Week 3",  "First MyCase workflow automations live"),
    ("Month 3", "Delegation plan running for Summer & Leo"),
]

CLOSING_QUOTE = (
    '"I want the firm to grow without it costing me another hour of my day."'
)
