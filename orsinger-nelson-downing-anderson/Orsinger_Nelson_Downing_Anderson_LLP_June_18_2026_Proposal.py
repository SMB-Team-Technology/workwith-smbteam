...
Firm: Orsinger, Nelson, Downing & Anderson, LLP (Jeff Anderson)
Date: June 18, 2026
Rep: Dan Bryant
"""
...
# ═══════════════════════════════════════════════════════════════════
# FILL — All values drawn from completed audit sections
# ═══════════════════════════════════════════════════════════════════

FIRM_NAME   = "Orsinger, Nelson, Downing & Anderson, LLP"
SALES_REP   = "Dan Bryant"
OUTPUT_PATH = "orsinger-nelson-downing-anderson/Orsinger_Nelson_Downing_Anderson_LLP_June_18_2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL",  "22 vs. 226 reviews"),
    ("AMBER", "AMBER",     "No intake process"),
    ("AMBER", "AMBER",     "Team of 2, no roles"),
    ("AMBER", "AMBER",     "Revenue undisclosed"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "22 reviews vs. Coker Robb's 226 — nearly invisible in Frisco map pack"),
    ("neg", "Zero paid ads — competitors capture Frisco divorce search traffic daily"),
    ("neg", "No intake follow-up — high-value cases lost to faster respondents"),
    ("pos", "4.8-star rating — highest average in the competitive set"),
]

COMPETITORS = [
    ("Coker, Robb & Cannon",  "226 reviews", "Frisco · map pack dominant"),
    ("Hargrave Family Law",   "115+ reviews", "4.9 stars · Dallas/Frisco"),
    ("Moore Family Law, P.C.", "100+ reviews", "PPC active · Frisco"),
]
CLIENT_REVIEWS      = "22 reviews"
CLIENT_REVIEWS_NOTE = "← You are here"

STAGE_TEXT = "Stage 4: Small Business Manager  →  Stage 6: Law Firm Owner"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reclaim the Frisco & Dallas Market"

SMB_MODEL_DESC = (
    "Lead Generation, Intake, Team, and Profit — four pillars that must "
    "work together as one system. When all four are running, Jeff can "
    "practice the complex family law he spent 30 years mastering, "
    "without managing vendor failures or being the bottleneck "
    "in his own growth."
)

GOAL_HEADLINE = "+20% More Leads Now · Full Scale in 6 Months"
GOAL_DBM      = "Practice law without managing marketing problems"

PRIORITIES = [
    (
        "Build the", "Marketing Engine", "1D4ED8",
        [
            "Build reviews to close the 10x Coker Robb gap",
            "Switch GBP to Divorce Attorney primary category",
            "Launch PPC: board-certified divorce, tightly targeted",
            "Fix NAP across all directories — recover rankings",
    ...
    (
        ...
        [
            "Add same-day follow-up for every new inquiry",
            "Give Alicia a dedicated intake role from ops",
            "Add homepage contact form above the fold",
            "Set up after-hours response for off-hours calls",
            "Track every lead from first contact to signed client",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Build org chart before the 6-month hiring round",
            "Define Jeff-the-attorney vs. Jeff-the-business-owner",
            "Create role accountability structure before new hires",
            "Track ROI by case type: which cases earn the most",
            "Model expansion costs against revenue before committing",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$11,397", "$11,997/mo",
        "Google PPC · GBP optimization · Review gen · SEO · Meta",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "Weekly coaching · Practice masterminds · Quarterly workshops",
        "6D28D9",
    ),
]

BUNDLE_TOTAL   = "$14,597 / mo"
...
AVG_CASE_VALUE      = "$15,000"
CONSERVATIVE_LABEL  = "Conservative  (2–3 cases/mo):"
CONSERVATIVE_RESULT = "$37,500 revenue · 10.7x ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (6–7 cases/mo):"
AGGRESSIVE_RESULT   = "$97,500 revenue · 13.9x ROAS"

TIMELINE = [
    ("Day 1",   "Launch targeted Google Search ads for Frisco divorce"),
    ("Day 14",  "Audit and correct NAP across all major directories"),
    ("Week 2",  "Optimize GBP categories; launch review campaign"),
    ("Week 3",  "Website tech audit + homepage video brief"),
    ("Month 3", "Elite Coach onboarding: intake + team framework"),
]

CLOSING_QUOTE = (
    '"I have the credentials and the track record. '
    'I just need a partner who makes the digital side match what I have built over 30 years."'
)
