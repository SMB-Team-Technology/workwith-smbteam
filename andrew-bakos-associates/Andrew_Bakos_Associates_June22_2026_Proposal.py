"""
Audit PowerPoint — Andrew Bakos & Associates
...
FIRM_NAME   = "Andrew Bakos & Associates"
SALES_REP   = "Jacob Meissner"
OUTPUT_PATH = "andrew-bakos-associates/Andrew_Bakos_Associates_June22_2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL",  "Referrals ↓ 90%; no ads"),
    ("RED",   "CRITICAL",  "Atty handles all intake"),
    ("AMBER", "IN PROGRESS", "2-person firm; no ops"),
    ("AMBER", "IN PROGRESS", "No revenue target set"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "Referrals collapsed 90% — from 10–20/mo to 1–2, with no digital pipeline to replace them"),
    ("neg", "Invisible online: 0 local 3-pack appearances and only 8 Google reviews vs. 900+ for Demas Law Group"),
    ("neg", "Intake runs through Andrew personally — a bottleneck that cannot scale when ads generate new leads"),
    ("pos", "35+ year trial reputation with 60–70% win rate and specialty in non-economic damages — rare in this market"),
]

COMPETITORS = [
    ("Demas Law Group",    "900+ reviews",  "4.9 stars · LSA + Ads dominant"),
    ("AutoAccident.com",   "10.0 Avvo",     "24/7 · 4 offices · 40+ yr brand"),
    ("Arnold Law Firm",    "100+ reviews",  "$60M verdict · aggressive PPC"),
]
CLIENT_REVIEWS      = "8 reviews"
CLIENT_REVIEWS_NOTE = "← You are here"

STAGE_TEXT = "Stage 3: Solo Practitioner  →  Goal: Stage 6, Law Firm Owner"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Build the Practice You Want"

SMB_MODEL_DESC = (
    "Lead Generation. Intake. Team. Profit. "
    "All four must work together — one missing pillar is enough to stall growth. "
    "When all four work, Andrew can finally take the cases he chooses and practice on his own terms."
)

GOAL_HEADLINE = "5–10 high-value cases/year"
GOAL_DBM      = "Choose your cases. Practice your way. Exit on your terms."

PRIORITIES = [
    (
        "Build the", "Marketing Engine", "1D4ED8",
        [
            "Turn Google into a catastrophic injury pipeline",
            "Launch LSA — pay per call, top of Google",
            "Fix NAP inconsistency suppressing local rankings",
            "Build 30+ Google reviews to unlock 3-pack",
            "Meta retargeting + TBI-targeted video ads",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Document Andrew's intake process to delegate",
            "Add after-hours coverage for catastrophic calls",
            "Build follow-up sequence for non-immediate leads",
            "Hire part-time intake coordinator when ads launch",
            "Install contact form auto-response on website",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Define the financial target for the final chapter",
            "Set monthly case count + revenue tracking",
            "Build case type selection criteria for delegation",
            "Plan ops structure to handle increased case volume",
            "Track marketing ROI by campaign and case type",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,847", "$5,697/mo",
        "Website rebuild · Google Ads · LSA · Local SEO · Meta Ads",
        "1D4ED8",
    ),
    (
        "ELITE COACH",
        "$2,600", "$3,497/mo",
        "Weekly group coaching · PI masterminds · intake systems",
        "6D28D9",
    ),
]
...
AVG_CASE_VALUE      = "$8,000 (est.)"
CONSERVATIVE_LABEL  = "Conservative  (7 cases/mo):"
CONSERVATIVE_RESULT = "$56,000 revenue · 5x ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (19 cases/mo):"
AGGRESSIVE_RESULT   = "$152,000 revenue · 6x ROAS"

TIMELINE = [
    ("Day 1",    "Onboarding + ad strategy kickoff"),
    ("Day 14",   "Google Ads live — catastrophic injury/TBI"),
    ("Week 3",   "LSA verified + Google Screened active"),
    ("Month 2",  "Website rebuild live; NAP audit complete"),
    ("Month 3",  "Coaching kickoff; intake process documented"),
]

CLOSING_QUOTE = (
    '"The next five years should be the best of this practice — '
    'the cases I choose, the results I know how to get, '
    'and the exit I have earned."'
)
