...
# Report metadata
FIRM_NAME      = "The Law Offices of Natalie Rowland"
SALES_REP      = "Jacob Meissner"
OUTPUT_PATH    = "the-law-offices-of-natalie-rowland/The_Law_Offices_of_Natalie_Rowland_August 21, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED", "RED", "0 reviews, no site"),
    ("RED", "RED", "No delegation yet"),
    ("RED", "RED", "Solo + 3-wk-old VA"),
    ("RED", "RED", "No profit plan yet"),
]
...
FINDINGS = [
    ("neg", "Zero online visibility while competitors dominate every search"),
    ("neg", "No delegation — owner personally handles 100% of intake"),
    ("neg", "No profit plan sits behind the stated $1M/yr goal"),
    ("pos", "Existing 4.0/5.0 Avvo rating shows real client trust already"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
# List 3 competitors + the client row is added automatically.
COMPETITORS = [
    ("Naggiar & Sarif",          "Established base", "Super Lawyers Top 5"),
    ("Stern Edlin Graham",       "Reviews present",   "Dedicated Buckhead content"),
    ("Kaye Lembeck Hitt & French","Reviews present",  "High-asset landing pages"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $1M/Year"

SMB_MODEL_DESC = (
    "All four pillars must work together \u2014 lead generation, intake, team, "
    "and profit. When they do, Natalie can grow to $1M/yr while staying "
    "personally involved with the clients and cases she chooses."
)

GOAL_HEADLINE = "$250K \u2192 $1M revenue"
GOAL_DBM      = "Choose her own clients and cases"
...
PRIORITIES = [
    (
        ...
        [
            "Build a real Google review base from clients",
            "Rebuild the site around the high-asset rebrand",
            "Fix NAP inconsistencies across directories",
            "Prepare for Local Service Ads eligibility",
            "Turn 18 years of reputation into visible proof",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "69CD2B",
        [
            "Document intake SOPs for the new assistant",
            "Add a working contact form to the website",
            "Build an after-hours response path",
            "Turn intake into a system she can trust",
            "Free up billable hours from admin work",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "003A59",
        [
            "Formalize delegation plan with her assistant",
            "Build a profit plan around high-asset cases",
            "Track case value as the practice repositions",
            "Reduce owner dependency without losing control",
            "Turn $1M/yr into real take-home, not just hours",
        ],
    ),
]
...
PACKAGES = [
    (
        "RECOMMENDED COACHING PACKAGE — ELITE COACH",
        "$3,497", "stand-alone rate",
        "Weekly group coaching \u00b7 SOP build-out \u00b7 Practice masterminds",
        "003A59",
    ),
]

BUNDLE_TOTAL   = "$3,497 / mo"
BUNDLE_SAVINGS = "Single stand-alone service \u2014 no bundle discount"

AD_SPEND_NOTE = (
    "+ Ad spend: not recommended in Phase 1 \u2014 site and reviews come first"
)

AVG_CASE_VALUE     = "N/A (Phase 2)"
CONSERVATIVE_LABEL = "Conservative (Phase 2):"
CONSERVATIVE_RESULT = "To be scoped once site/reviews are live"
AGGRESSIVE_LABEL   = "Aggressive (Phase 2):"
AGGRESSIVE_RESULT  = "To be scoped once site/reviews are live"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Kick off Elite Coach \u2014 SOP & delegation planning"),
    ("Day 14",  "Launch Google review request process"),
    ("Week 2",  "Begin scoping website rebuild"),
    ("Week 3",  "Clean up NAP inconsistencies across directories"),
    ("Month 3", "Baseline profit-tracking process in place"),
]

CLOSING_QUOTE = (
    '"I want to grow this practice on my terms \u2014 hands-on with the '
    'clients I choose, without losing myself in someone else\'s system."'
)
