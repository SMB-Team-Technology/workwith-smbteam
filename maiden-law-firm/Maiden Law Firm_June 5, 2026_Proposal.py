"""
Audit PowerPoint — Maiden Law Firm
...
# ═══════════════════════════════════════════════════════════════════
# FILL — All values extracted from section files
# ═══════════════════════════════════════════════════════════════════

FIRM_NAME   = "Maiden Law Firm"
SALES_REP   = "Randy Gold"
OUTPUT_PATH = "maiden-law-firm/Maiden Law Firm_June 5, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL",  "No ads on any channel"),
    ("RED",   "CRITICAL",  "No after-hours coverage"),
    ("AMBER", "AMBER",     "Attorney manages intake"),
    ("AMBER", "AMBER",     "No revenue baseline"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "No paid ads — every PI search goes to Joye or Drennan"),
    ("neg", "31 reviews vs. 730+ — invisible in the local 3-pack"),
    ("neg", "No after-hours intake; attorney handles all inquiries"),
    ("pos", "4.5-star reputation — strong foundation to build from"),
]

COMPETITORS = [
    ("Drennan Law Firm",        "730 reviews",   "5.0 stars · local pack dominant"),
    ("Joye Law Firm",           "2,260+ reviews","4.9 stars · ads on every channel"),
    ("Christmas Injury Lawyers","177 reviews",   "4.9 stars · 3-pack competitor"),
]
CLIENT_REVIEWS      = "31 reviews"
...
SMB_MODEL_DESC = (
    ...
    "When all four pillars are in place, Brooke can step back from the "
    "day-to-day and trust that the firm is handling it."
)

GOAL_HEADLINE = "$500K → $1M revenue"
GOAL_DBM      = "Step back — and trust the firm handles it"

PRIORITIES = [
    (
        "Build the", "Marketing Engine", "1D4ED8",
        [
            "Launch Google Ads for car accident + PI keywords",
            "Activate LSA — top-of-page, pay per lead only",
            "Build 50+ Google reviews in 90 days",
            "Add city pages: Charleston + N. Charleston",
    ...
    (
        ...
        [
            "Install after-hours intake coverage",
            "Automate 60-sec form response: text + email",
            "Build a CRM to track every lead to close",
            "Define intake script for car accident inquiries",
            "Stop losing cases to the first firm that calls back",
        ],
    ),
    (
        ...
        [
            ...
            "Build org chart and delegation SOPs",
            "Establish revenue baseline + monthly target",
            "Define owner draw — planned, not reactive",
            "Build a firm that runs when Brooke steps out",
        ],
    ),
]
...
CONSERVATIVE_RESULT = "~$41,000 revenue · ~4× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (13–14 cases/mo):"
AGGRESSIVE_RESULT   = "~$100,000 revenue · ~5× ROAS"
...
CLOSING_QUOTE = (
    '"The cases are in this market — Joye Law Firm and Drennan Law Firm are proving it every day. '
    'Brooke has the reputation. What she needs now is the system to capture them."'
)
