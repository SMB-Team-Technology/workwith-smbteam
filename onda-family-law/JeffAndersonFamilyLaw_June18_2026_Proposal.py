...
# Report metadata
FIRM_NAME      = "Jeff Anderson Family Law, PLLC"
SALES_REP      = "Dan Bryant"
OUTPUT_PATH    = "onda-family-law/JeffAndersonFamilyLaw_June18_2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL",  "Invisible in 3-pack"),
    ("AMBER", "AMBER",     "No call tracking"),
    ("AMBER", "AMBER",     "Owner-dependent ops"),
    ("AMBER", "AMBER",     "No revenue baseline"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "22 reviews vs. 240–317 for top Frisco competitors; invisible in Maps 3-pack across all searches"),
    ("neg", "Zero PPC or Meta Ads running while Pfister, Goranson, and Albin Oldner hold every paid position"),
    ("neg", "5 NAP mismatches across Avvo, FindLaw, and ONDA directories actively suppress local ranking authority"),
    ("pos", "Board Certified, Top 100 TX, 4.8-star GBPs in two markets — elite credibility ready to amplify"),
]

COMPETITORS = [
    ("Pfister Family Law",    "240 reviews", "Board Certified · Frisco 3-pack"),
    ("Ramage Law Group",      "317 reviews", "Multi-location DFW · aggressive SEO"),
    ("Goranson Bain Ausley",  "4.8 stars",   "Dominant Dallas high-net-worth"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Capture the Market You Have Earned"

SMB_MODEL_DESC = (
    "Lead Generation, Intake, Team, and Profit must all work together — "
    "fixing one while ignoring the others produces short-term results that do not compound. "
    "When all four fire, Jeff can build the dominant DFW family law practice his credentials "
    "have always deserved — and lead it instead of running it."
)

GOAL_HEADLINE = "+20% Cases/Month → Dominant DFW Practice"
GOAL_DBM      = "Build the practice my credentials have earned"

PRIORITIES = [
    (
        "Build the", "Marketing Engine", "1D4ED8",
        [
            "Google Ads live — divorce & custody Frisco/Dallas",
            "Fix NAP errors; restore Maps authority now",
            "GBP optimized; review generation system live",
            "Turn Google into a 24/7 client pipeline",
            "San Antonio: new market, no new office cost",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "CallRail installed before day-one ad spend",
            "After-hours protocol — no inquiry lost to timing",
            "Fix directory phone errors losing warm leads",
            "Know exactly which channel closes every case",
            "Convert more leads without one more ad dollar",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Coaching framework before 6-month expansion",
            "Org structure for new staff — growth, not chaos",
            "Revenue baseline set before marketing launches",
            "Aleshia's energy channeled into real systems",
            "Profit planned and predictable — not discovered",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,847", "$5,697/mo",
        "Website · Google Ads · GBP management · Local SEO · Citations",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
...
AVG_CASE_VALUE      = "$20,000"
CONSERVATIVE_LABEL  = "Conservative  (2–3 cases/mo):"
CONSERVATIVE_RESULT = "$40K–$60K revenue · 11–17× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (4–6 cases/mo):"
AGGRESSIVE_RESULT   = "$80K–$120K revenue · 12–17× ROAS"

TIMELINE = [
    ("Day 1",   "Google Ads + CallRail live in Frisco & Dallas"),
    ("Day 14",  "NAP audit complete; all directory errors corrected"),
    ("Week 2",  "GBP optimized; review generation process live"),
    ("Week 3",  "Website rebuild underway; San Antonio page scoped"),
    ("Month 3", "Coaching live; expansion roadmap confirmed"),
]

CLOSING_QUOTE = (
    '"You have spent 30 years earning the reputation. '
    "Now it's time to build the platform that delivers the clients to match it.\""
)
