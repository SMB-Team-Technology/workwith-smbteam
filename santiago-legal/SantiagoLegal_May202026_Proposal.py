"""
Audit PowerPoint — Santiago Legal LLC
...
FIRM_NAME   = "Santiago Legal LLC"
SALES_REP   = "Randy Gold"
OUTPUT_PATH = "santiago-legal/SantiagoLegal_May202026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL", "0 reviews, no ads"),
    ("RED",   "CRITICAL", "No CTA, no coverage"),
    ("RED",   "CRITICAL", "Solo op, no team"),
    ("AMBER", "MODERATE", "No profit visibility"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "Zero reviews vs. 68–118 for competitors — invisible where clients search first"),
    ("neg", "No ads on Google, LSA, or Meta — all high-intent search traffic goes to rivals"),
    ("neg", "Solo intake model caps firm capacity at one attorney's personal hours"),
    ("pos", "Bilingual website + 16-yr Spanish-language expertise — rare competitive edge"),
]

COMPETITORS = [
    ("Capriotti International Law", "118 reviews", "Minnetonka · 47 yrs"),
    ("Ostrom Law Office",           "93 reviews",  "10.0 rating · AILA"),
    ("Dyan Williams Law PLLC",      "68 reviews",  "bilingual podcast/YT"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach Minnesota Market Leadership"

SMB_MODEL_DESC = (
    "Lead Generation. Intake. Self-Managing Team. Profit Plan. "
    "All four must work together — one missing pillar caps the others. "
    "When Karla has all four running, she can serve the Latino community at scale "
    "and step back from the day-to-day."
)

GOAL_HEADLINE = "Karla → MN's go-to immigration attorney"
GOAL_DBM      = "Serve more families. Work fewer hours."

PRIORITIES = [
    (
        "Build the", "Marketing Engine", "1D4ED8",
        [
            "Launch bilingual Google Ads in EN + ES",
            "Build GBP + run review generation campaign",
            "Set up LSA for top-of-Google lead placement",
            "Meta ads targeting MN's 300K Latino community",
    ...
    (
        ...
        [
            "Add clear CTA above fold on homepage",
            "Build after-hours response system",
            "Design structured intake process for all leads",
            "Every inquiry gets fast bilingual follow-up",
            "Stop routing every new call through Karla",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Hire first bilingual intake coordinator",
            "Set revenue baseline + track by case type",
            "Fix dual-domain NAP to unlock SEO gains",
            "Install profit plan — know what you keep",
            "Build the firm Karla can step back from",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,847", "$5,697/mo",
        "Website · Bilingual Google Ads · LSA · Meta · GBP",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "1:1 coaching · intake system · first hire framework",
        "6D28D9",
    ),
]
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $8,000–$15,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE      = "$3,750"
CONSERVATIVE_LABEL  = "Conservative  (12 cases/mo):"
CONSERVATIVE_RESULT = "$45,000 revenue · 5.6× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (28 cases/mo):"
AGGRESSIVE_RESULT   = "$105,000 revenue · 7.0× ROAS"

TIMELINE = [
    ("Day 1",   "Coaching kickoff + intake process design"),
    ("Day 14",  "Bilingual Google Ads go live EN + ES"),
    ("Week 2",  "GBP built, review outreach campaign launched"),
    ("Week 3",  "Website CTA + domain NAP fix deployed"),
    ("Month 3", "LSA active, Meta running, 20+ leads/mo"),
]

CLOSING_QUOTE = (
    '"I have served this community for 16 years. '
    'The next 16 belong to them finding me."'
)
