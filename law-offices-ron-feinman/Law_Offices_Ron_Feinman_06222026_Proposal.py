"""
Audit PowerPoint — Law Offices of Ron Feinman
...
FIRM_NAME   = "Law Offices of Ron Feinman"
SALES_REP   = "Jacob Meissner"
OUTPUT_PATH = "law-offices-ron-feinman/Law_Offices_Ron_Feinman_06222026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL", "Referrals only, no system"),
    ("AMBER", "AMBER",    "No documented process"),
    ("RED",   "CRITICAL", "Lost 2 attorneys"),
    ("AMBER", "AMBER",    "No financial dashboard"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "Invisible online — 4 reviews vs. competitors' 11–36"),
    ("neg", "Lost 2 attorneys; Ron managing caseload & hiring alone"),
    ("neg", "No paid ads — growth depends entirely on referrals"),
    ("pos", "5.0-star Google rating — highest quality signal locally"),
]

COMPETITORS = [
    ("Davies & Davies",              "36 reviews", "4.7★ · leads estate planning pack"),
    ("Estate & Elder Law Center",    "13+ reviews", "4.7★ · elder law specialist"),
    ("A.R. Pike Law Firm",           "~11 reviews", "4.6★ · consistent 3-pack presence"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $2.5M"

SMB_MODEL_DESC = (
    "SMB Team builds all four pillars at once — marketing, intake, "
    "team, and profit. When they work together, Ron can step back "
    "and trust the firm runs without him."
)

GOAL_HEADLINE = "$1.25M → $2.5M revenue"
GOAL_DBM      = "Firm runs — Ron steps back"
...
PRIORITIES = [
    (
        ...
        [
            ...
            "Dominate local pack before a rival claims it first",
            "Launch LSA — pay per lead, not per click",
            "Build review volume: 4 reviews to 30+ in 90 days",
            "Fix NAP inconsistencies suppressing Google ranking",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Build intake script for complex elder law consults",
            "Add after-hours coverage — prospects don't wait",
            "Track every inquiry so no lead falls through",
            "Respond first — first firm to reply wins the case",
            "Delegate intake from Ron; reclaim 3–4 hrs/day",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Build hiring system that attracts A-player attorneys",
            "Fill paralegal role now — critical ops gap open",
            "Add 2 attorneys for complex elder law caseload",
            "Dashboard: revenue, margin, cost-per-matter",
            "Phase in FCOO leadership once team is rebuilt",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$7,397", "$8,997/mo",
        "Website · Google Ads · LSA · Meta Ads · SEO · Review gen",
        "1D4ED8",
    ),
    (
        "MASTER'S CIRCLE",
...
CONSERVATIVE_RESULT = "$9,000 revenue · 2.1× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (12 cases/mo):"
AGGRESSIVE_RESULT   = "$36,000 revenue · 2.6× ROAS"

TIMELINE = [
    ("Day 1",    "Coaching kickoff — hiring priorities set"),
    ("Day 14",   "Google Ads live for elder law searches"),
    ("Week 3",   "Review campaign + GBP optimization live"),
    ("Week 4",   "NAP audit and citation cleanup complete"),
    ("Month 3",  "25+ new reviews added, ads producing leads"),
]

CLOSING_QUOTE = (
    '"A well-oiled machine that runs without me — 3 to 4 hours back '
    'every day, the right team in place, and the freedom to build '
    'the practice I actually want."'
)
