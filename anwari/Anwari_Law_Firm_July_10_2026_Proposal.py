"""
Audit PowerPoint — Anwari Law Firm
July 10, 2026  |  Rep: Jonathan Farace
Generated by SMB Team audit pipeline.
"""
...
FIRM_NAME   = "Anwari Law Firm"
SALES_REP   = "Jonathan Farace"
OUTPUT_PATH = "anwari/Anwari_Law_Firm_July_10_2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL",    "No paid ads, 13+ years"),
    ("AMBER", "AMBER",       "No follow-up system"),
    ("RED",   "CRITICAL",    "Sole attorney, no team"),
    ("AMBER", "AMBER",       "No profit plan in place"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "Zero paid ads + unclaimed GBP — invisible while competitors run active campaigns across every channel"),
    ("neg", "Dari-language capability is the firm's strongest differentiator — but is entirely absent from the website and digital presence"),
    ("neg", "Revenue dropped 50–70% from a $1.5M peak with no acquisition system to compensate for policy-driven demand loss"),
    ("pos", "273 Google reviews at 4.6 stars — more verified reviews than most local competitors, a strong credibility foundation"),
]

COMPETITORS = [
    ("Montagut & Sobral, PC",       "345 reviews", "Active GBP · 8 attorneys"),
    ("Rodriguez Legal, PLC",        "~263 reviews", "4.9 stars · same street"),
    ("Law Office of Federico Serrano", "Active",   "Paid search · multilingual"),
]
CLIENT_REVIEWS      = "273 reviews · 4.6 ★"
...
SMB_MODEL_DESC = (
    ...
    "missing any one means growth stalls regardless of what you invest. "
    "When all four pillars are in place, Deeba can step back from daily operations "
    "and the firm will keep running — and growing — without her."
)

GOAL_HEADLINE = "$40K–$80K/mo  →  $125K/month"
GOAL_DBM      = "A business that runs — and a legacy that lasts"

PRIORITIES = [
    (
        "Build the", "Marketing Engine", "1D4ED8",
        [
            "Claim + optimize the Google Business Profile",
            "Launch Google Ads — family + employment immigration",
            "Enroll in LSA — Google Screened top-of-search",
            "Build Dari-language pages — zero competition",
    ...
    (
        ...
        [
            "Add consultation CTA above the fold on homepage",
            "Implement 3-touch follow-up after every consult",
            "Standardize intake tracking across both locations",
            "Cover after-hours — capture inquiries you're missing",
            "Each saved lead at $4,500 is revenue already earned",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Correct NAP inconsistencies — remove local SEO gap",
            "Build associate attorney hiring + training roadmap",
            "Track profitability by practice area — know margins",
            "Establish 12-month plan from $80K to $125K/month",
            "Build the team that makes semi-retirement possible",
        ],
    ),
]
...
PACKAGES = [
    ...
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "Weekly coaching · Immigration mastermind · Quarterly workshops",
        "6D28D9",
    ),
]
...
CONSERVATIVE_RESULT = "~$22,500 revenue · ~7.5× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (~22 cases/mo):"
AGGRESSIVE_RESULT   = "~$99,000 revenue · ~8× ROAS"

TIMELINE = [
    ("Day 1",    "Google Ads launch — family + employment immigration"),
    ("Day 14",   "GBP claimed + optimized across both VA locations"),
    ("Week 3",   "Website modernization — Dari pages + CTA above fold"),
    ("Week 4",   "LSA enrollment submitted — Google Screened process"),
    ("Month 3",  "Coaching kickoff — revenue targets + hiring roadmap"),
]

CLOSING_QUOTE = (
    '"The firm I built serves my community and sustains itself — '
    'long after I\'ve finally stepped back."'
)
