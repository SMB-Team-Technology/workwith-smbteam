...
# Report metadata
FIRM_NAME      = "Silversmith Legal"
SALES_REP      = "Dan Bryant"
OUTPUT_PATH    = "silversmith-legal/SilversmithLegal_June22_2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL",  "No ads, no SEO, no system"),
    ("AMBER", "AMBER",     "No contact form on site"),
    ("AMBER", "AMBER",     "Owner drives all new biz"),
    ("AMBER", "AMBER",     "No revenue target set"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "Zero digital presence — invisible to any prospect searching estate planning or probate"),
    ("neg", "No contact form or landing pages — website cannot generate or convert a single online lead"),
    ("neg", "1–3 Google reviews vs. 245 for the top Denver competitor — local 3-pack is out of reach"),
    ("pos", "5.0-star rating, two offices, associate handling estate planning — the foundation is real"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Legacy Law Group CO",       "245 reviews", "Denver estate planning #1"),
    ("CO Estate Planning Center", "66 reviews",  "Front Range organic leader"),
    ("Heckman & O'Connor PC",     "~3 reviews",  "Vail Valley 40+ yr incumbent"),
]
CLIENT_REVIEWS      = "1–3 reviews"
...
SMB_MODEL_DESC = (
    "SMB Team's four-pillar model — Lead Generation, Intake, Team, and Profit — "
    "works as a system. Fix one in isolation and growth stalls at the next constraint. "
    "When all four work together, Chris can step back and trust that Amy is running "
    "the firm he built."
)

GOAL_HEADLINE = "$800K → $1.5M revenue"
GOAL_DBM      = "Step back — Amy runs the firm you built"
...
PRIORITIES = [
    (
        ...
        [
            "Turn Google into a probate lead pipeline",
            "Launch LSA — $50/call, no competitors yet",
            "Rebuild site: contact form + practice pages",
            "Build 20+ Google reviews to unlock 3-pack",
            "Meta ads: educate + retarget estate prospects",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Contact form captures after-hours leads",
            "Define intake scripts for Amy's consults",
            "Build follow-up for leads who don't sign",
            "Get Google Screened — trust badge on search",
            "Systemize response to new probate inquiries",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Set $1.5M revenue target — track weekly",
            "Train Amy on probate to free Chris from it",
            "Document case processes — knowledge in firm",
            "Track cost-per-case for each practice area",
            "Weekly KPI dashboard for the whole team",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$7,397", "$8,997/mo",
        "Website · Google Ads · LSA · Meta Ads · GBP management",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "Weekly coaching · Practice masterminds · Intake systems",
        "6D28D9",
    ),
]
...
CONSERVATIVE_RESULT = "$14,000 revenue · 4.0× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (12–14 cases/mo):"
AGGRESSIVE_RESULT   = "$52,000 revenue · 3.7× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Coaching kickoff — revenue target + KPIs set"),
    ("Day 14",  "Google Ads + LSA campaigns live in Vail Valley"),
    ("Week 2",  "Website rebuild underway; contact form goes live"),
    ("Week 3",  "Review campaign starts — 20+ reviews targeted"),
    ("Month 3", "Denver/Front Range landing pages in development"),
]

CLOSING_QUOTE = (
    '"The leads are there, the market is open — and once the system is built, '
    'Amy runs the practice while Chris runs the firm."'
)
