...
OUTPUT_PATH    = "rlb-legal/RLB Legal_July 23, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "RED",   "95%+ from referrals"),
    ("RED",   "RED",   "No embedded contact form"),
    ("AMBER", "AMBER", "Owner at 50-60 hrs/wk"),
...
FINDINGS = [
    ("neg", "No paid marketing ever run — 95%+ referral-only pipeline"),
    ("neg", "Lorem Ipsum testimonials & Avvo address error live now"),
    ("neg", "Owner works 50-60 hrs/wk with no documented hiring plan"),
    ("pos", "Built a genuine $500K first year on reputation alone"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Potter Minton, P.C.",  "BBB A+",      "4 attys · Super Lawyers"),
    ("The Dacus Firm, P.C.", "Since 2009",  "2 attys · Super Lawyers"),
    ("Wilson Law Firm",      "Est. firm",   "Oil & gas specialists"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $2-3M"

SMB_MODEL_DESC = (
    "All four pillars — marketing, intake, team, and profit — work together. "
    "When they do, Reagan can finally step away from running every intake call himself."
)

GOAL_HEADLINE = "$500K → $2-3M"
GOAL_DBM      = "Hire proactively, not reactively"
...
PRIORITIES = [
    (
        ...
        [
            "Launch Google Ads & LSA for litigation + energy",
            "Turn referrals into a system that runs without you",
            "Fix Lorem Ipsum testimonials & Avvo address error",
            "Build geo-pages for Midland, Dallas, Houston",
            "Add Meta retargeting & AI-avatar video content",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Add embedded contact form — cut click-through friction",
            "Define after-hours coverage for evening inquiries",
            "Track every lead so none slip through unseen",
            "Turn intake into a system, not a personal task",
            "Protect the white-glove feel as volume grows",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Start Elite Coach Plus — build a documented hiring plan",
            "Hire proactively instead of reacting to overload",
            "Track cost-per-case before scaling ad spend",
            "Benchmark case value across litigation & transactional",
            "Turn revenue growth into real, predictable profit",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,997", "$5,697/mo",
        "Google Ads · LSA · Local SEO · Meta Ads · Website Fixes",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
...
AVG_CASE_VALUE     = "$3,000–$7,000 (est.)"
CONSERVATIVE_LABEL = "Conservative  (3 cases/mo):"
CONSERVATIVE_RESULT = "$15,000 revenue · 5.0× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (17 cases/mo):"
AGGRESSIVE_RESULT  = "$85,000 revenue · 7.1× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch Google Ads & LSA campaigns"),
    ("Day 14",  "Fix testimonials & correct Avvo NAP error"),
    ("Week 2",  "Add embedded contact form to website"),
    ("Week 3",  "Kick off Elite Coach Plus sessions"),
    ("Month 3", "Cost-per-case tracking live & reviewed"),
]

CLOSING_QUOTE = (
    '"I want to hire because we\'re ready — not because we\'re already underwater."'
)
