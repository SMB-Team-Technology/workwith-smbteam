"""
Audit PowerPoint — Granados Law Group, PLLC
SMB Team | Jacob Meissner | June 11, 2026
Generated by SMB Team Audit Pipeline (Pass 3)
"""
...
FIRM_NAME   = "Granados Law Group"
SALES_REP   = "Jacob Meissner"
OUTPUT_PATH = "granados/GranadosLawGroup_June112026_Proposal.pptx"
...
PILLARS = [
    ("AMBER", "AMBER",    "Ads dark nights/weekends"),
    ("RED",   "CRITICAL", "No after-hours coverage"),
    ("AMBER", "AMBER",    "No documented systems"),
    ("RED",   "CRITICAL", "No financial forecast"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "Ads go dark at night — DWI arrests peak Friday at midnight; competitors answer"),
    ("neg", "No answering service — every after-hours call goes to Saad Law or Kurtz & Blum"),
    ("neg", "Lindsey is the intake bottleneck for every high-value felony case"),
    ("pos", "4.8-star rating matches the best Cary competitors — quality is already there"),
]

COMPETITORS = [
    ("Kurtz & Blum (Raleigh)",        "290 reviews", "4.7★ · Raleigh · full coverage"),
    ("Saad Law (Raleigh)",             "275 reviews", "4.9★ · ex-DA · 24/7 ads"),
    ("Amy Whinery Osborne (Cary)",     "208 reviews", "4.8★ · Cary-based rival"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $1.25M"

SMB_MODEL_DESC = (
    "The SMB Team model works all four pillars — Marketing, Intake, "
    "Team, and Profit — as a single integrated system. "
    "When all four work together, Lindsey can finally step away from "
    "daily operations and trust the firm runs without her."
)

GOAL_HEADLINE = "$750K → $1.25M revenue"
...
PRIORITIES = [
    (
        ...
        [
            ...
            "Run ads Thurs–Sun when DWI arrests spike",
            "Track every ad dollar back to signed cases",
            "Close the review gap with top competitors",
            "Target high-value felony keywords only",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Activate after-hours answering — 0 missed calls",
            "Capture DWI calls at 2am when clients need help",
            "Free Lindsey from every high-value intake call",
            "Formalize the associate intake handoff process",
            "Add instant website contact above the fold",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Document the 10 core firm playbooks",
            "Build delegation — stop being the bottleneck",
            "Track cost per case by practice area",
            "Build a revenue plan tied to the $1.25M goal",
            "Free 1–2 hrs/day from low-value admin work",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,847", "$5,697/mo",
        "Google Ads · LSA · SEO · Website CRO · ROI Reporting",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "Weekly coaching · Masterminds · Team systems · Workshops",
        "6D28D9",
    ),
]
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $7,500–$13,500/mo paid directly to Google/Meta"
)
...
AGGRESSIVE_RESULT   = "~$80,000 revenue · ~6× ROAS"

TIMELINE = [
    ("Day 1",    "Launch 24/7 Google Ads & LSA campaigns"),
    ("Day 14",   "After-hours answering service activated"),
    ("Week 2",   "Website conversion optimization live"),
    ("Week 3",   "Review generation program launched"),
    ("Month 3",  "Team systems & playbooks documented"),
]

CLOSING_QUOTE = (
    '"You take two weeks off. You come back and the firm ran itself — '
    'cases signed, revenue coming in, team handled it. That is what we are building."'
)
