...
# Report metadata
FIRM_NAME      = "Ferrell Law Firm"
SALES_REP      = "Randy Gold"
OUTPUT_PATH    = "ferrell/Ferrell_Law_Firm_August_14_2026_Proposal.pptx"
...
FINDINGS = [
    ("neg", "Zero online reviews vs. 90-243 for named competitors"),
    ("neg", "No CRM, no after-hours coverage — leads can be lost"),
    ("neg", "Revenue swung $100K-$700K/yr with no profit plan"),
    ("pos", "Mobile-responsive site with a real attorney bio in place"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Foster Wallace, LLC",   "243 reviews", "$1B+ settlements"),
    ("McShane & Brady, LLC",  "122 reviews", "SEO-built site"),
    ("Dickerson Oxton, LLC",  "N/A",         "Est. 2010 · KC"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $250K-$350K Net Profit"

SMB_MODEL_DESC = (
    "All four pillars — leads, intake, team, and profit — must work "
    "together. When they do, Andrew can finally step away and trust the firm "
    "runs, leaving room for family, investments, and ministry."
)

GOAL_HEADLINE = "$250K → $350K net profit"
GOAL_DBM      = "Time back for family, investing, and ministry"
...
PRIORITIES = [
    (
        ...
        [
            "Stand up a Google Business Profile",
            "Turn Google Ads into a pipeline that runs itself",
            "Finish the website before sending it traffic",
            "Build directory presence and fix NAP errors",
            "Start generating verified client reviews",
        ],
    ),
    (
        ...
        [
            ...
            "Build a simple, defined follow-up process",
            "Add after-hours coverage for new inquiries",
            "Free your time by not chasing every lead alone",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "003A59",
        [
            "Build a profit plan around your net profit goal",
            "Turn proven lead flow into a confident hire",
            "Delegate admin work so you can practice law",
            "Track case value to protect your margins",
            "Scale to 20 cases without scaling your hours",
        ],
    ),
]
...
AVG_CASE_VALUE     = "$6,500 (PI default)"
CONSERVATIVE_LABEL = "Conservative  (~4 cases/mo):"
CONSERVATIVE_RESULT = "$24,000 revenue · 3.2× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (~14 cases/mo):"
AGGRESSIVE_RESULT  = "$88,500 revenue · 4.4× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch Google Ads and stand up GBP"),
    ("Day 14",  "Website finished, ready for ad traffic"),
    ("Week 2",  "Elite Coach Plus coaching kicks off"),
    ("Week 3",  "Directory listings corrected and live"),
    ("Month 3", "First reviews live, lead flow established"),
]

CLOSING_QUOTE = (
    '"Gain more time for family, investments, and ministry work."'
)
