"""
Audit PowerPoint — Lasser Law Group
Sales Rep: Randy Gold | Date: June 2, 2026
Generated by: SMB Team Audit Agent (Pass 3)
"""
...
FIRM_NAME   = "Lasser Law Group"
SALES_REP   = "Randy Gold"
OUTPUT_PATH = "lasser-law-group/LasserLawGroup_June2_2026_Proposal.pptx"
...
# Copied from section_05 sc-card traffic lights and first findings bullet each
PILLARS = [
    ("RED",   "CRITICAL",  "No ads / no 3-pack"),
    ("AMBER", "AMBER",     "No live chat / form"),
    ("AMBER", "AMBER",     "No mgmt layer yet"),
    ("AMBER", "AMBER",     "No margin tracking"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Copied from section_executive_summary.html top priorities
FINDINGS = [
    ("neg", "Zero paid ads, LSA, or 3-pack presence — online clients go to competitors"),
    ("neg", "3.6-star rating with 24 reviews actively losing comparison-shopping clients"),
    ("neg", "No above-fold contact form — website visitors leave without engaging"),
    ("pos", "20+ yrs expertise, 9 attorneys, video podcast — credibility already built"),
]

# Copied from section_06_lead_generation.html competitor data
COMPETITORS = [
    ("Goldberg & Lindenberg PC",  "57 reviews · 4.2★", "landlord-tenant dominant"),
    ("Gallet Dreyer & Berkey LLP", "50+ yr history",    "co-op/condo institution"),
    ("Belkin Burden Goldman LLP",  "60 attorneys",      "Chambers-ranked · 300+ boards"),
]
CLIENT_REVIEWS      = "24 reviews · 3.6★"
...
PRIORITIES = [
    (
        ...
        [
            ...
            "Enroll in LSA — get Google Screened badge",
            "Recover GBP rating above 4.0 stars",
            "Repurpose video podcast into paid ad content",
            "Claim top-3 local pack for NYC RE searches",
        ],
    ),
    (
        ...
        [
            ...
            "Build same-day web lead response process",
            "Add after-hours coverage for urgent clients",
            "Track every lead from contact to signed",
            "Fix FindLaw + Yelp NAP — recover SEO signals",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Add dedicated intake coordinator role",
            "Build KPI dashboard per practice area",
            "Track profit margin by matter type",
            "Create Westchester + LI geo landing pages",
            "Build management layer across 3 offices",
        ],
    ),
]
