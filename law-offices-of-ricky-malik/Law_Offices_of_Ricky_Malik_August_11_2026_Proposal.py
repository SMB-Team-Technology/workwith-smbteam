...
# Report metadata
FIRM_NAME      = "Law Offices of Ricky Malik, P.C."
SALES_REP      = "Jacob Meissner"
OUTPUT_PATH    = "law-offices-of-ricky-malik/Law_Offices_of_Ricky_Malik_August_11_2026_Proposal.pptx"
...
PILLARS = [
    ("AMBER", "AMBER",    "Marginal gains only"),
    ("AMBER", "AMBER",    "Spanish-accent bias"),
    ("RED",   "CRITICAL", "Ricky is bottleneck"),
    ("RED",   "CRITICAL", "No profit visibility"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "Ricky absorbs every problem his team should catch"),
    ("neg", "Spanish-accent intake bias caps non-Hispanic growth"),
    ("neg", "No profit visibility beyond monthly retainer counts"),
    ("pos", "391 five-star reviews outrank every named competitor"),
]

COMPETITORS = [
    ("Murray Osorio PLLC",   "183 reviews", "Fairfax · 4.9★, broad reach"),
    ("Alcock & Associates",  "97 reviews",  "Manassas · same market"),
    ("SRIS Law Group",       "19+ reviews", "Fairfax · multi-practice scale"),
]
CLIENT_REVIEWS      = "391 reviews"
CLIENT_REVIEWS_NOTE = "← You are here"

STAGE_TEXT = "Stage 4: Small Business Manager  →  Goal: Stage 6, Law Firm Owner"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach 30 Retainers/Month"

SMB_MODEL_DESC = (
    "All four pillars — lead gen, intake, team, and profit — have to work "
    "together. For Ricky, the missing piece isn't leads; it's a team that runs "
    "the systems already in place. When all four work, Ricky can finally step "
    "back from daily firefighting and run the business instead of the caseload."
)

GOAL_HEADLINE = "15-16 -> 30 retainers/mo"
GOAL_DBM      = "Step away from daily firefighting, for good"

PRIORITIES = [
    (
        "Fix the", "Operational Bottleneck", "0091C9",
        [
            "Get an FCOO enforcing SOPs, not you",
            "Coach your team into A-players",
            "Fix the 2-of-8 A-player turnover cycle",
            "Formalize the associate-attorney handoff",
            "Free you for business-level work",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Leads", "69CD2B",
        [
            "Fix the Spanish-accent intake bias",
            "Stop losing leads to Smith.ai drop-offs",
            "Add a non-Hispanic-facing intake path",
            "Track average case value per matter",
            "Convert more of the $5K/mo you already spend",
        ],
    ),
    (
        "Build AI &", "Profit Systems", "003A59",
        [
            "Build the 'Ricky GPT' SOP-enforcement tool",
            "Deploy Fractional CTO Level 1 support",
            "Install real profit & case-value tracking",
            "Confirm PageSpeed & fix quick website wins",
            "Prep Phase 2: Spanish-language ad campaign",
        ],
    ),
]
...
PACKAGES = [
    (
        "ELITE COACH PLUS + FCOO ADVISOR",
        "$5,694", "$7,294/mo",
        "Weekly coaching · FCOO SOP enforcement · A-player build",
        "0091C9",
    ),
    (
        "FRACTIONAL CTO LEVEL 1 (LAW)",
        "$3,297", "$3,797/mo",
        "Claude Enterprise · AI Skills · SOP automation build",
        "003A59",
    ),
]

BUNDLE_TOTAL   = "$8,991 / mo"
BUNDLE_SAVINGS = "Save $2,100/mo by bundling"

AD_SPEND_NOTE = (
    "+ Phase 2 ad spend (not now): $8,000-$15,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE      = "$4,500"
CONSERVATIVE_LABEL  = "Conservative  (12 cases/mo):"
CONSERVATIVE_RESULT = "$54,000 revenue · 6.8x ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (28 cases/mo):"
AGGRESSIVE_RESULT   = "$126,000 revenue · 8.4x ROAS"

TIMELINE = [
    ("Day 1",   "Kickoff Elite Coach Plus + FCOO Advisor"),
    ("Day 14",  "FCOO begins team deep-dive & SOP audit"),
    ("Week 2",  "Fractional CTO L1 + AI Foundation Sprint"),
    ("Week 3",  "PageSpeed re-check & website quick-win fixes"),
    ("Month 3", "Case-value tracking live; Phase 2 ads scoped"),
]

CLOSING_QUOTE = (
    '"I built this firm one relationship at a time. I don\'t need more '
    'hustle - I need a team that runs it while I finally get to lead it."'
)
