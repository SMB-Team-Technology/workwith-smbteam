...
# Report metadata
FIRM_NAME      = "Kemp Injury Law"
SALES_REP      = "Jonathan Farace"
OUTPUT_PATH    = "kemp-injury-law/Kemp Injury Law_July 27, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL", "0 signed cases last month"),
    ("AMBER", "AMBER",    "24/7 coverage, no tracking"),
    ("RED",   "CRITICAL", "Only 1.5 attorneys total"),
    ("RED",   "CRITICAL", "No case value or P&L data"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "Case signings fell from 15-20/mo to zero after a website hack"),
    ("neg", "Third marketing agency in a row shows no measurable results"),
    ("neg", "No case value, revenue goal, or profit visibility exists yet"),
    ("pos", "5.0-star rating across 74 reviews — reputation holds up well"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Brooks Law Group",     "244 reviews", "4.7★ · 30+ yrs in Winter Haven"),
    ("Burnetti, P.A.",       "8 reviews",   "9-office regional firm"),
    ("The Florida Law Group", "5.0★ rating", "Est. 1984 · AV Preeminent"),
]
CLIENT_REVIEWS      = "74 reviews (5.0★)"
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach 30 Cases a Month"

SMB_MODEL_DESC = (
    "All four pillars — leads, intake, team, and profit — have to work "
    "together. When they do, Kemp Injury Law can reach 30 cases a month "
    "without Adam running every part of it himself."
)

GOAL_HEADLINE = "15-20 → 30 cases/mo"
GOAL_DBM      = "Adam steps back to focus on his other businesses"

PRIORITIES = [
    (
        "Build the", "Marketing Engine", "1D4ED8",
        [
            "Relaunch PPC, LSA, and Meta after the hack",
            "Fix the missing \"car accident lawyer\" term",
            "Resolve the bot wall blocking search crawlers",
            "Rebuild rankings on existing geo-pages",
            "Turn ads into a pipeline that runs without Adam",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Track total monthly lead volume for the first time",
            "Audit handoffs between answering service & staff",
            "Fix the lead leakage Adam already flagged",
            "Give the existing 24/7 intake setup real measurement",
            "Protect every lead the new ads generate",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Start Elite Coach Plus leadership coaching",
            "Build accountability toward 3 lawyers, 10 staff",
            "Track average case value for the first time",
            "Add cost-per-acquisition visibility",
            "Free Adam to refocus on his other businesses",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$7,497", "$8,997/mo",
        "Website · SEO · Google Ads · LSA · Meta Ads · GBP",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $13,500–$35,800/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE     = "$7,500"
CONSERVATIVE_LABEL = "Conservative  (3 cases/mo):"
CONSERVATIVE_RESULT = "$22,500 revenue · 1.7× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (9 cases/mo):"
AGGRESSIVE_RESULT  = "$67,500 revenue · 1.9× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch PPC, LSA, and Meta retargeting"),
    ("Day 14",  "Resolve bot wall; confirm PageSpeed scores"),
    ("Week 2",  "Correct FindLaw NAP; start Elite Coach Plus"),
    ("Week 3",  "Stand up lead-volume tracking"),
    ("Month 3", "Rebuilding toward the pre-hack 15-20 cases/mo"),
]

CLOSING_QUOTE = (
    '"Kemp Injury Law runs itself — so I can focus on my other businesses."'
)
