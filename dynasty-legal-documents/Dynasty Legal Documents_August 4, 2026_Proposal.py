...
# Report metadata
FIRM_NAME      = "Dynasty Legal Documents"
SALES_REP      = "Jacob Meissner"
OUTPUT_PATH    = "dynasty-legal-documents/Dynasty Legal Documents_August 4, 2026_Proposal.pptx"
...
PILLARS = [
    ("AMBER", "AMBER",    "3 vendors, no sync"),   # Lead Generation
    ("RED",   "CRITICAL", "Only she answers"),      # Intake
    ("RED",   "CRITICAL", "No employees yet"),      # Team
...
FINDINGS = [
    ("neg", "Melissa personally handles every lead, call, and case at both locations"),
    ("neg", "Two phone numbers and inconsistent listings undercut her own ad spend"),
    ("neg", "Named competitors are outpacing her on reviews, footprint, and tenure"),
    ("pos", "A 5.0-star reputation already driving real, steady demand"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Affordable Legal Document Specialists", "23 reviews", "4.9★ · after-hours"),
    ("AZ Legal Documents LLC",                "Multi-loc.", "Gilbert/Tempe/Mesa"),
    ("Legal Document Prep",                   "Est. 1988",  "Decades of tenure"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $30K/Month, Consistently"

SMB_MODEL_DESC = (
    "All four pillars — leads, intake, team, and profit — have to work together. "
    "When they do, Melissa can finally step back and bring on the help she needs."
)

GOAL_HEADLINE = "$30K → $60K/Month"
GOAL_DBM      = "A team that finally shares the load"
...
PRIORITIES = [
    (
        ...
        [
            "Launch coordinated PPC, LSA & Meta management",
            "Fix NAP across Google, site & directories",
            "Add a bio page that builds instant trust",
            "Win local searches for family law needs",
    ...
    (
        ...
        [
            "Build a real follow-up sequence for leads",
            "Add after-hours coverage beyond the form",
            "Track which lead source actually converts",
            "Stop losing paid leads before you call back",
            "Free your evenings from chasing every lead",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Start weekly coaching & accountability",
            "Document systems your next hire can use",
            "Track profit by practice area, not just revenue",
            "Build the plan that gets you to $60K/month",
            "Create the system that finally hires for you",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,997", "$5,697/mo",
        "Website · SEO · LSA · Google PPC · Social · GBP (2 locations)",
        "1D4ED8",
    ),
    (
        "ELITE COACH",
...
BUNDLE_SAVINGS = "Save $1,597/mo by bundling"

AD_SPEND_NOTE = (
    "+ Recommended ad spend: $6,700–$14,300/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE     = "$1,200–$1,500"
CONSERVATIVE_LABEL = "Conservative  (9 cases/mo):"
CONSERVATIVE_RESULT = "$11,700 revenue · 1.7× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (22 cases/mo):"
AGGRESSIVE_RESULT  = "$29,700 revenue · 2.1× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Ads & vendors move under one coordinated team"),
    ("Day 14",  "NAP fixed across Google, site & directories"),
    ("Week 2",  "Bio page live; local content underway"),
    ("Week 3",  "Elite Coach weekly sessions begin"),
    ("Month 3", "Review-generation program closes the Yelp gap"),
]

CLOSING_QUOTE = (
    '"A practice that runs without me answering every call — '
    'so I can finally bring someone on to help carry it."'
)
