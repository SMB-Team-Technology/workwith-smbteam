...
# Report metadata
FIRM_NAME      = "Sage Estate & Business Law"
SALES_REP      = "Michael Kopp"
OUTPUT_PATH    = "sage-planning/Sage Planning_August 17, 2026_Proposal.pptx"
...
PILLARS = [
    ...
    ("AMBER", "AMBER", "No lead follow-up"),      # Intake
    ("RED",   "RED",   "Charles is CEO + atty"),  # Team
    ("AMBER", "AMBER", "Stale pricing"),           # Profit Plan
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "Charles is CEO and lead attorney at once, capping growth"),
    ("neg", "Every directory still misdirects his name to his old firm"),
    ("neg", "Seminar and referral leads get no formal follow-up"),
    ("pos", "$160K generated in 4 months with zero paid marketing"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Sandberg, Stettler & White", "93 reviews", "4.8★ · dominates Kaysville"),
    ("Ascent Law LLC",             "22 reviews", "4.8★ · Salt Lake / Wasatch"),
    ("Christopher J. Salcido",     "Unverified", "Ogden · 17 yrs in estate law"),
]
CLIENT_REVIEWS      = "Unverified"
CLIENT_REVIEWS_NOTE = "← 4 months old"

# Stage strip (right panel, Slide 1)
STAGE_TEXT = "Stage 3: Solo Practitioner  →  Goal: Stage 6, Law Firm Owner"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $600K"

SMB_MODEL_DESC = (
    "SMB Team's model runs on four pillars working together — lead generation, "
    "intake, team, and profit — so growth doesn't rest on one person's shoulders. "
    "When all four are in place, Charles can finally be 50% CEO and 50% attorney, "
    "instead of both jobs at once."
)

GOAL_HEADLINE = "$160K → $600K revenue"
GOAL_DBM      = "Charles is 50% CEO, 50% attorney"
...
PRIORITIES = [
    (
        ...
        [
            "Turn referrals into a repeatable engine, not luck",
            "Fix directory listings before spending on ads",
            "Build local SEO content for Northern Utah",
            "Add geo pages for Ogden, Layton, Kaysville, SLC",
            "Layer in paid search once the foundation is set",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "69CD2B",
        [
            "Add a homepage contact form",
            "Build a real seminar follow-up sequence",
            "Track every referral lead start to finish",
            "Stop losing signed cases to slow follow-up",
            "Free Charles from personally handling intake",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "003A59",
        [
            "Bring in a Fractional COO to run operations",
            "Document SOPs and scorecards for the team",
            "Re-price estate plans and business formations",
            "Build a real profit dashboard, not guesswork",
            "Turn 50/50 CEO/attorney into how each week runs",
        ],
    ),
]
...
PACKAGES = [
    (
        "FRACTIONAL COO — LEVEL 1",
        "$3,797", "$3,797/mo",
        "SOPs · financial metrics · marketing optimization · pricing review",
        "0091C9",
    ),
    (
        "INCLUDED: ELITE COACH GROUP DELIVERABLES",
        "$0", "$0/mo",
        "Weekly group coaching · masterminds · quarterly + annual workshop",
        "003A59",
    ),
]

BUNDLE_TOTAL   = "$3,797 / mo"
BUNDLE_SAVINGS = "Single-product engagement — no bundling discount applies"

AD_SPEND_NOTE = (
    "Future opportunity, not part of this engagement: $3,500–$14,000/mo "
    "paid directly to Google/Meta"
)

AVG_CASE_VALUE     = "$2,500 (stated, estate plans)"
CONSERVATIVE_LABEL = "Conservative  (~3 cases/mo):"
CONSERVATIVE_RESULT = "~$7,500 revenue · ~2× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (~22 cases/mo):"
AGGRESSIVE_RESULT  = "~$55,000 revenue · ~4× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Level 1 Fractional COO engagement kicks off"),
    ("Day 14",  "Directory listings claimed and corrected"),
    ("Week 2",  "Draft SOPs and role scorecards for the team"),
    ("Week 3",  "Pricing review vs. current market rates"),
    ("Month 3", "Financial dashboard live; follow-up system built"),
]

CLOSING_QUOTE = (
    '"I want to spend half my time running the business and half practicing '
    'law — not both, all the time."'
)
