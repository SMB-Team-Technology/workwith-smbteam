...
# Report metadata
FIRM_NAME      = "Guerra Law Offices, LLC"
SALES_REP      = "Randy Gold"
OUTPUT_PATH    = "guerra-law-offices/Guerra Law Offices, LLC_July 13, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "RED",   "100% referrals only"),
    ("RED",   "RED",   "No contact form"),
    ("RED",   "RED",   "Solo — no backup"),
    ("AMBER", "AMBER", "No cost-per-case"),
]
...
FINDINGS = [
    ("neg", "Zero reviews after 15 years vs. rivals' 49-290"),
    ("neg", "100% referral-dependent — no paid lead system"),
    ("neg", "Vacation means pausing new business — no team"),
    ("pos", "Bilingual PI/RE niche — no local competitor"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
# List 3 competitors + the client row is added automatically.
COMPETITORS = [
    ("Rob Levine Law",        "290 reviews", "4.9★ statewide brand"),
    ("d'Oliveira & Assoc.",   "235 reviews", "4.9★ 35-yr, multi-office"),
    ("Marasco & Nesselbush",  "49 reviews",  "4.8★ Providence"),
]
...
SMB_MODEL_DESC = (
    ...
    "together. Missing any one means growth stalls no matter how much you "
    "spend on ads. When all four work, Stella can finally step away and "
    "trust the firm keeps running."
)
...
PRIORITIES = [
    (
        ...
        [
            "Launch Google Ads & LSA for personal injury",
            "Add bilingual Spanish PI/RE campaigns",
            "Fix the website: mobile-ready contact form",
            "Start a review-generation program for trust",
            "Correct NAP listing errors hurting local search",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Add a real contact form — stop losing leads",
            "Build a fast-response process for after hours",
            "Track every lead so none disappear untouched",
            "Turn referral relationships into faster follow-up",
            "Free you from answering every single inquiry",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Build a coverage plan so you can step away",
            "Start tracking cost-per-case by practice area",
            "Create a profit plan tied to the $1M+ goal",
            "Get weekly coaching to build delegation systems",
            "Know your numbers before you scale ad spend",
        ],
    ),
]
...
CONSERVATIVE_RESULT = "$13,000 revenue · 1.7× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (8-9 cases/mo):"
AGGRESSIVE_RESULT  = "$55,250 revenue · 2.2× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch Google Ads & LSA for personal injury"),
    ("Day 14",  "Website rebuild goes live, mobile-ready"),
    ("Week 2",  "Elite Coach Plus coaching kickoff begins"),
    ("Week 3",  "Review-generation outreach starts"),
    ("Month 3", "Bilingual campaigns live, NAP errors fixed"),
]

CLOSING_QUOTE = (
    '"A real vacation, a firm that keeps growing — and it never once '
    'required a partner."'
)
