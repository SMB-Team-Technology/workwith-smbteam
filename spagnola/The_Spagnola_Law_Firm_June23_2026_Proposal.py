"""
Audit PowerPoint — The Spagnola Law Firm
SMB Team  |  Dan Bryant  |  June 23, 2026
"""
...
FIRM_NAME   = "The Spagnola Law Firm"
SALES_REP   = "Dan Bryant"
OUTPUT_PATH = "spagnola/The_Spagnola_Law_Firm_June23_2026_Proposal.pptx"
...
PILLARS = [
    ("AMBER", "AMBER",    "LSA only, 5% convert"),
    ("RED",   "CRITICAL", "No intake system"),
    ("RED",   "CRITICAL", "Solo; no backup plan"),
    ("AMBER", "AMBER",    "Revenue at $400K cap"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "Intake leaking 95% of paid leads — 1 consult from 21 LSA leads at $3K/mo"),
    ("neg", "No Google PPC for ~2 years while Kreider dominates paid positions"),
    ("neg", "Firm is one person deep — any absence halts revenue and client service"),
    ("pos", "Board Certified, Super Lawyer 2022–2026, 35+ years, 4.5 stars · 121 reviews"),
]

COMPETITORS = [
    ("Kreider Attorneys at Law",       "648 reviews", "5.0 ★ · former judge"),
    ("Law Ofc. Stephen E. Robertson",  "262 reviews", "4.8 ★ · 7-day coverage"),
    ("Woodruff Family Law Group",      "151 reviews", "4.6 ★ · 3 Board Certified"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach 12 Cases/Month"

SMB_MODEL_DESC = (
    "Lead generation, intake, team, and profit must all work together. "
    "Most firms stall because one pillar is broken — usually intake or team. "
    "When all four work, Samuel can build a firm that runs and earns "
    "without requiring him to be in the room every day."
)

GOAL_HEADLINE = "$400K → $1M revenue"
GOAL_DBM      = "A firm that earns while you're away"

PRIORITIES = [
    (
        "Build the", "Marketing Engine", "1D4ED8",
        [
            "Launch HHI-targeted PPC for contested divorce",
            "Turn Google into a pipeline that runs without you",
            "Fix LSA: lift conversion from 5% to 20%+",
            "Activate Meta retargeting (you requested this)",
            "Build reviews to close the 5x gap with Kreider",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Hire an intake coordinator — stop doing it yourself",
            "Add contact form for after-hours lead capture",
            "24/7 intake coverage beats Robertson's hours",
            "Build a consult close script for LSA leads",
            "Update GMB hours — reclaim evening map visibility",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Hire a 2nd attorney to carry 12 cases/month",
            "Coaching: accountability toward the 12-case goal",
            "Fix NAP: 3 phone numbers hurting local rankings",
            "Track cost per case — know your true margins",
            "Expand geo pages: Burlington, Winston-Salem",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,847", "$5,697/mo",
        "Google Ads · LSA mgmt · Meta retargeting · SEO · website",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "Weekly coaching · practice masterminds · workshops",
        "6D28D9",
    ),
]
...
CONSERVATIVE_RESULT = "$24,000 revenue · 5.3× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (15 cases/mo):"
AGGRESSIVE_RESULT   = "$120,000 revenue · 6.7× ROAS"

TIMELINE = [
    ("Day 1",   "Google LSA optimization begins immediately"),
    ("Day 14",  "Google PPC launches — HHI targeted"),
    ("Week 2",  "Meta pixel installed, retargeting live"),
    ("Week 3",  "Coaching kickoff: intake & 12-case framework"),
    ("Month 3", "Review campaign producing new reviews weekly"),
]

CLOSING_QUOTE = (
    '"The day this firm converts leads without me on the phone '
    'is the day I finally have what I\'ve been building toward."'
)
