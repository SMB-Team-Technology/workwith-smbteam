...
Output: rose-harper/Rose_Harper_Law_June_30_2026_Proposal.pptx
"""
...
# Report metadata
FIRM_NAME      = "Rose Harper Law"
SALES_REP      = "Jonathan Farace"
OUTPUT_PATH    = "rose-harper/Rose_Harper_Law_June_30_2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL", "No ads, no 3-pack rank"),   # Lead Generation
    ("RED",   "CRITICAL", "No after-hours coverage"),   # Intake
    ("AMBER", "AMBER",    "Team size unconfirmed"),      # Team
...
# Key findings
FINDINGS = [
    ("neg", "Firm not in local 3-pack for PI searches in NJ or NY — competitors capture every high-intent lead"),
    ("neg", "No after-hours intake: PI leads who reach voicemail call a competitor who answered and don't call back"),
    ("neg", "Three offices, no management layer — Rose coordinates intake and operations across 3 states personally"),
    ("pos", "20+ geo-targeted landing pages and bilingual Spanish content are strong SEO assets ready to be amplified"),
]

# Competitor table
COMPETITORS = [
    ("Brandon J. Broderick",  "388+ reviews", "5.0★ · dominant NJ PI advertiser"),
    ("Sobo & Sobo",           "300+ reviews", "4.7★ · Westchester/Rockland brand"),
    ("Kantrowitz Goldhamer",  "81+ reviews",  "4.7★ · Rockland County authority"),
]
CLIENT_REVIEWS      = "Not confirmed"
CLIENT_REVIEWS_NOTE = "← verify live"

# Stage strip (right panel, Slide 1)
STAGE_TEXT = "Stage 4: Small Business Manager  →  Goal: Stage 6, Law Firm Owner"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $1M+"

SMB_MODEL_DESC = (
    "Lead Generation, Intake, Team, and Profit must all "
    "work together — missing any one means growth stalls "
    "regardless of how much is spent on ads. "
    "When all four pillars align, Rose can step away from "
    "daily operations and trust the firm keeps producing."
)

GOAL_HEADLINE = "~$500K → $1M+ revenue"
GOAL_DBM      = "The firm runs while I'm home"
...
PRIORITIES = [
    (
        ...
        [
            "Launch Google Ads — NJ and NY PI markets now",
            "Activate LSA: pay per lead, top of Google",
            "Spanish PI campaign: bilingual edge rivals lack",
            "Close the review gap vs. Brandon Broderick (388)",
            "Leads come to you — not the other way around",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "After-hours coverage: answer before rivals do",
            "5-step follow-up converts leads who don't sign",
            "Centralize intake tracking across 3 office lines",
            "Less form friction — more cases from same traffic",
            "Never lose a lead while you're teaching your class",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Define roles — Rose leads, team runs each day",
            "Weekly KPIs: know what converts, cut what doesn't",
            "Revenue by office reveals where to invest",
            "Hire a dedicated intake coordinator by Month 2",
            "Know your take-home: build around a real number",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,847", "$5,697/mo",
        "Google Ads · LSA · Meta Ads · SEO · GBP (3 locations)",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "Weekly 1-on-1 · Group coaching · Quarterly workshops",
        "6D28D9",
    ),
]
...
CONSERVATIVE_LABEL = "Conservative  (8–10 cases/mo):"
CONSERVATIVE_RESULT = "$60K–$75K revenue · 6–7.5× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (25–27 cases/mo):"
AGGRESSIVE_RESULT  = "$185K–$200K revenue · 7.5× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Coaching kickoff — intake and KPI baseline set"),
    ("Day 14",  "Google Ads and LSA campaigns go live in NJ/NY"),
    ("Week 2",  "GBP optimized for all 3 locations; reviews launched"),
    ("Week 3",  "Spanish campaign and Meta retargeting go live"),
    ("Month 3", "After-hours intake measured; team roles formalized"),
]

CLOSING_QUOTE = (
    '"Three states, three offices, three kids, one professor — '
    'and finally, a firm that runs without me."'
)
