...
# Report metadata
FIRM_NAME      = "Naji Injury Law"
SALES_REP      = "Randy Gold"
OUTPUT_PATH    = "naji-injury-law/Naji Injury Law_July 23, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL", "75% from 1 vendor"),
    ("GREEN", "GREEN",    "88% conversion"),
    ("AMBER", "AMBER",    "Owner in every hire"),
    ("AMBER", "AMBER",    "On pace for $1M"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "Renting 75% of leads from a vendor with zero conversions since July 3"),
    ("neg", "Invisible in local search against Brown & Crouppen and Schultz & Myers"),
    ("neg", "$3M/$7M revenue goals with no profit plan or margin visibility yet"),
    ("pos", "88% conversion rate — the intake team is already a genuine strength"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Brown & Crouppen",  "38 reviews",  "St. Louis's top PI brand"),
    ("Schultz & Myers",   "812 reviews", "4.9★ reputation leader"),
    ("Cofman Townsley",   "13 reviews",  "50+ yrs, same submarket"),
]
CLIENT_REVIEWS      = "Unclaimed profile"
...
SMB_MODEL_DESC = (
    ...
    "together for growth to compound. When they do, Jamil gets the return on his "
    "hours he's after, not just more revenue."
)

GOAL_HEADLINE = "$1M → $3M revenue"
GOAL_DBM      = "Own the pipeline — scale without more hours"
...
PRIORITIES = [
    (
        ...
        [
            "Replace the failing lead vendor with owned ads",
            "Claim & optimize Google Business Profile + Avvo",
            "Build missing practice-area & geo landing pages",
            "Launch LSA — pay per lead, above the map pack",
            "Turn Google into a pipeline that's truly yours",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Protect the 88% conversion rate as volume grows",
            "Add after-hours / overflow coverage",
            "Feed real volume to a team that's ready for it",
            "Track conversion by channel as leads scale up",
            "Make sure growth doesn't outpace your team",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Move the next hire decision off your desk",
            "Build a profit plan before hitting $3M",
            "Launch Fractional CTO-led AI automation",
            "Automate medical records & billing follow-ups",
            "Coach delegation habits with Elite Coach Plus",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$7,497", "$8,997/mo",
        "Local SEO · Google Ads · LSA · Meta Ads · GBP + Elite Coach Plus",
        "1D4ED8",
    ),
    (
        "FRACTIONAL CTO — LEVEL 1",
        "$3,297", "$3,797/mo",
        "Custom AI automation built into your existing Claude AI setup",
        "6D28D9",
    ),
]

BUNDLE_TOTAL   = "$13,994 / mo"
BUNDLE_SAVINGS = "Save $2,297/mo by bundling"

AD_SPEND_NOTE = (
    "+ Recommended ad spend: $15,000–$50,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE      = "$5,000–$8,000"
CONSERVATIVE_LABEL  = "Conservative  (5 cases/mo):"
CONSERVATIVE_RESULT = "$32,500 revenue · 2.2× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (20 cases/mo):"
AGGRESSIVE_RESULT   = "$130,000 revenue · 2.6× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch Google Ads, LSA & Meta campaigns"),
    ("Day 14",  "Claim & optimize GBP and Avvo profiles"),
    ("Week 2",  "Kick off Elite Coach Plus coaching sessions"),
    ("Week 3",  "Begin Fractional CTO AI automation build"),
    ("Month 3", "New practice-area & geo pages live"),
]

CLOSING_QUOTE = (
    '"I want more return on my hours — not fewer of them. Build me a firm '
    'that owns its leads, not one that rents them, and gets me to $3M '
    'without costing me more of myself."'
)
