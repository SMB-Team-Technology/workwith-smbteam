...
# Report metadata
FIRM_NAME      = "Dumas & Sanclemente, PLLC"
SALES_REP      = "Jacob Meissner"
OUTPUT_PATH    = "dumas-sanclemente/Dumas & Sanclemente_August 18, 2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL", "No paid ads ever run"),
    ("RED",   "CRITICAL", "No defined process"),
    ("AMBER", "AMBER",    "Two-attorney core"),
...
FINDINGS = [
    ("neg", "Zero paid marketing means the firm is invisible where named competitors already win"),
    ("neg", "NAP inconsistencies across 3 addresses are suppressing local map-pack rankings"),
    ("neg", "No intake tracking means the firm can't measure how many referrals actually convert"),
    ("pos", "Two experienced, complementary attorneys and 250+ litigated cases give real credibility to build on"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Englander Peebles",  "202 reviews", "4.9★ · Ft. Lauderdale"),
    ("Diaco Law",          "126-157 reviews", "4.6-4.8★ · Tampa"),
    ("Swope, Rodante P.A.", "43 reviews", "4.7-4.8★ · Tampa"),
]
CLIENT_REVIEWS      = "~121 (unverified)"
...
SMB_MODEL_DESC = (
    ...
    "When they do, Axel and Jonathan can finally step back and let the firm run without them."
)

GOAL_HEADLINE = "$1.2M → $2.5M+ revenue"
GOAL_DBM      = "Become the go-to PI firm in your markets"
...
PRIORITIES = [
    (
        ...
        [
            "Launch Google Ads in Tampa Bay & Ft. Lauderdale",
            "Add Local Service Ads for pay-per-lead visibility",
            "Fix NAP across all directories to boost rankings",
            "Launch a Spanish-language ad campaign",
    ...
    (
        ...
        [
            "Build a defined intake process with tracking",
            "Add after-hours coverage for referral calls",
            "Track which leads convert and which go quiet",
            "Train a consistent follow-up sequence",
    ...
    (
        ...
        [
            "Add a leadership layer beyond the two of you",
            "Build profit visibility — know your true margins",
            "Start Elite Coach Plus group coaching",
            "Plan for a Fractional COO as caseload grows",
            "Let the firm grow without more hours from you",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$7,497", "$8,997/mo",
        "Google Ads · LSA · Meta Ads · Local SEO · Spanish campaign",
        "0091C9",
    ),
    (
        "ELITE COACH PLUS",
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $19,500–$24,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE     = "$7,500"
CONSERVATIVE_LABEL = "Conservative  (5 cases/mo):"
CONSERVATIVE_RESULT = "$41,100 revenue · 2.1× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (8 cases/mo):"
AGGRESSIVE_RESULT  = "$60,700 revenue · 2.5× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch Google Ads & LSA in both markets + Spanish"),
    ("Day 14",  "NAP cleanup complete across all directory listings"),
    ("Week 2",  "New geo-targeted landing pages live for key cities"),
    ("Week 3",  "Elite Coach Plus kickoff — build intake tracking"),
    ("Month 3", "Meta retargeting & video ads live; profit baseline set"),
]

CLOSING_QUOTE = (
    '"Step away from referrals alone — and become the firm people '
    'in Tampa Bay and South Florida call first."'
)
