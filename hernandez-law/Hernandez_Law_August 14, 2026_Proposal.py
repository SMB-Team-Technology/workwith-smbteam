...
# Report metadata
FIRM_NAME      = "Hernandez Law"
SALES_REP      = "Dan Bryant"
OUTPUT_PATH    = "hernandez-law/Hernandez_Law_August 14, 2026_Proposal.pptx"
...
PILLARS = [
    ("AMBER", "AMBER",    "Referral network slowing"),   # Lead Generation
    ("RED",   "CRITICAL", "Owner handles most intake"),  # Intake
    ("AMBER", "AMBER",    "Everything routes to owner"), # Team
...
FINDINGS = [
    ("neg", "Revenue declining to ~$500K in 2026 vs. ~$1M in prior years"),
    ("neg", "GBP category/address mismatch hides firm from local search"),
    ("neg", "Intake bottlenecks through Tatiana during litigation weeks"),
    ("pos", "Growing team of 2 staff, a law clerk, and a contract attorney"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
# List 3 competitors + the client row is added automatically.
COMPETITORS = [
    ("Setareh Law Group",         "17 reviews", "25+ yrs · $1B+ recovered"),
    ("Matern Law Group",          "19 reviews", "Strong intake reputation"),
    ("Blady Workforce Law Group", "17 reviews", "AV-rated · LA-based"),
]
CLIENT_REVIEWS      = "0 reviews"
CLIENT_REVIEWS_NOTE = "← You are here"

# Stage strip (right panel, Slide 1)
STAGE_TEXT = "Stage: Owner Runs Everything  →  Goal: A Firm That Runs Itself"

# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach 5+ Cases a Month"

SMB_MODEL_DESC = (
    "All four pillars — Marketing, Intake, Team, and Profit — must work "
    "together. When all four pillars work, Tatiana can finally step away "
    "from the intake pile and trust the firm still runs."
)

GOAL_HEADLINE = "~$500K → 5+ cases/mo"
GOAL_DBM      = "Step away from intake and trust the firm runs"
...
PRIORITIES = [
    (
        ...
        [
            ...
            "Launch English-language Google Ads campaigns",
            "Build reviews so prospects trust you, not just referrals",
            "Turn Google into a case pipeline that runs without you",
        ],
    ),
    (
        ...
        [
            ...
            "Build a follow-up sequence for slower responders",
            "Reduce delays during your busiest litigation weeks",
            "Let cases come in without routing through you first",
        ],
    ),
    (
        ...
        [
            ...
            "Confirm ad spend is still paying for itself",
            "Set monthly reporting on lead source and conversion",
            "Give Tatiana back the bandwidth discovery weeks take",
        ],
    ),
]
...
BUNDLE_SAVINGS = "Save $300/mo by bundling"

AD_SPEND_NOTE = (
    "+ Recommended ad spend: $3,000–$5,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE     = "$30,000–$50,000+"
CONSERVATIVE_LABEL = "Conservative  (3 cases/mo):"
CONSERVATIVE_RESULT = "$120,000 revenue · 40× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (6–7 cases/mo):"
AGGRESSIVE_RESULT  = "$272,000 revenue · 54× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Launch corrected bilingual Google Ads campaigns"),
    ("Day 14",  "Fix GBP category & Beverly Hills address"),
    ("Week 2",  "Begin EN/ES site consolidation & on-page SEO"),
    ("Week 3",  "Launch review generation sequence"),
    ("Month 3", "Baseline reporting on lead source & conversion live"),
]

CLOSING_QUOTE = (
    '"I want a firm that keeps generating cases and taking care of '
    'clients whether or not I\'m the one answering the phone that day."'
)
