...
story.append(b("$1M+ revenue with 5+ dedicated staff and structured operations team qualifies for Master's Circle."))
story.append(b("Connects Heather to a peer cohort of owners who have already solved the $4M-to-$7M transition."))
story.append(b("Accountability structure replaces agency oversight burden — Caitlyn leads forward instead of backward."))
...
story.append(b("<b>Aggressive:</b> $5M growth target x 20% / 12 = $83,333 theoretical max; capped at Growth tier limit of $25,000/mo."))
...
price_data = [[Paragraph("<b>Full Service Marketing Growth</b>", S["price_main"]), Paragraph("$7,397/mo", S["price_main"])], [Paragraph("Website, SEO, PPC + LSA + Meta + GBP + signed-case attribution.", S["price_detail"]), Paragraph("<strike>$8,997</strike> stand alone", S["price_detail"])], [Paragraph("<b>Master's Circle</b>", S["price_main"]), Paragraph("$4,600/mo", S["price_main"])], [Paragraph("Elite Coach + High Level Mastermind + Team Training.", S["price_detail"]), Paragraph("<strike>$4,997</strike> stand alone", S["price_detail"])], [Paragraph("<b>Recommended Ad Spend</b>", S["price_main"]), Paragraph("$15,000–$25,000/mo", S["price_main"])], [Paragraph("Goes to Google, LSA, and Meta — not to SMB Team.", S["price_detail"]), Paragraph("", S["price_detail"])]]
...
story.append(pt)
story.append(Paragraph("Total: $11,997/mo + $15,000–$25,000 ad spend  |  Save $1,997/mo by bundling  |  Ad spend = 6–10% of current revenue (under 35% cap)", S["savings"]))
