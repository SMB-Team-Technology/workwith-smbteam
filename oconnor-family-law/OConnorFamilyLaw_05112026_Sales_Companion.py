...
story.append(Paragraph("<b>Platinum Marketing  |  $6,997/mo bundled</b>", S["subsection"]))
...
story.append(Paragraph("<b>Master’s Circle + FCOO Partner  |  $5,394/mo bundled</b>", S["subsection"]))
...
price_data = [[Paragraph("<b>Platinum Marketing</b>", S["price_main"]), Paragraph("$6,997/mo", S["price_main"])], [Paragraph("Signed-case attribution, PPC + LSA + Meta + GBP + website conversion.", S["price_detail"]), Paragraph("<strike>$7,997</strike> stand alone", S["price_detail"])], [Paragraph("<b>Master’s Circle + FCOO Partner</b>", S["price_main"]), Paragraph("$5,394/mo", S["price_main"])], [Paragraph("Peer cohort coaching + fractional COO advisory for Caitlyn + CFO partnership.", S["price_detail"]), Paragraph("<strike>$6,794</strike> stand alone", S["price_detail"])], [Paragraph("<b>Recommended Ad Spend</b>", S["price_main"]), Paragraph("$15,000–$25,000/mo", S["price_main"])], [Paragraph("Goes to Google, LSA, and Meta — not to SMB Team.", S["price_detail"]), Paragraph("", S["price_detail"])]]
...
story.append(pt)
story.append(Paragraph("Total: $12,391/mo + $15,000–$25,000 ad spend  |  Save $2,400/mo by bundling  |  Ad spend = 6–10% of current revenue (under 35% cap)", S["savings"]))
