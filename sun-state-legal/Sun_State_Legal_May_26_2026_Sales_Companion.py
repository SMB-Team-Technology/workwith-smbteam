...
Prepared: May 26, 2026 | Rep: Jonathan Farace
...
OUTPUT_PATH = "sun-state-legal/Sun_State_Legal_May_26_2026_Sales_Companion.pdf"
...
story.append(bd("Sun State Legal enters searches where JacksonWhite and Houk Employment Attorneys currently win."))
story.append(bd("Creates a website and digital presence that converts referral and paid traffic alike."))

story.append(Paragraph("<b>Full Service Marketing Starter  |  $4,847/mo bundled</b>", S["subsection"]))
story.append(b("Revenue ~$500K: $400K-$1M Starter tier applies."))
...
story.append(b("Phoenix = Tier 2 market; employment law rewards active paid search and strong GBP presence."))
...
story.append(bd("Structures the practitioner-to-entrepreneur transition he came to SMB Team to start."))
story.append(bd("Collaborative, measured accountability — the exact style Nate described wanting."))

story.append(Paragraph("<b>Elite Coach Plus  |  $3,200/mo bundled</b>", S["subsection"]))
story.append(b("Revenue $400K-$1M, any team size: Elite Coach Plus is the correct tier."))
...
story.append(Paragraph("<b>What it does for him:</b>", S["subsection"]))
story.append(bd("Puts Sun State Legal in front of high-intent employment searches — cases currently going to JacksonWhite and Shields Petitti &amp; Zoldan."))
story.append(bd("Employment matters at $5K-$15K+ mean even conservative ad results return multiple times the spend."))

story.append(Paragraph("<b>Conservative $4,000/mo to Aggressive $5,000/mo:</b>", S["subsection"]))
...
story.append(Paragraph("<i>Estimates only. Not guaranteed. Employment case values vary significantly.</i>", S["disclaimer"]))
...
story.append(Paragraph('"I\'m skeptical about the revenue potential from ads."', S["objection_q"]))
story.append(Paragraph("Anchor on what he said: 4-5 qualified voicemails/week going unanswered. At 15% close and $5K avg, that is $15K-$20K/mo in cases already arriving that are going cold — before a dollar of additional marketing.", S["objection_a"]))

story.append(Paragraph('"I had a bad experience with a coach."', S["objection_q"]))
story.append(Paragraph("Elite Coach Plus is peer-based group coaching — not one-on-one pressure. Collaborative, measured approach; he sets the pace with attorneys at the same growth stage.", S["objection_a"]))

story.append(Paragraph('"Does paid search work for employment law?"', S["objection_q"]))
story.append(Paragraph("JacksonWhite (681+ Google reviews) and Shields Petitti &amp; Zoldan (5.0 stars, PPC-optimized landing pages) are both running active paid search for employment keywords in Chandler. The channel works — he is just not in it.", S["objection_a"]))

story.append(Paragraph('"I\'m not in a rush."', S["objection_q"]))
story.append(Paragraph("JacksonWhite has 681+ Google reviews growing every month. Local SEO takes 6-12 months to build. The urgency score for this market is 7/10 — competitors are actively dominating multiple channels and the gap widens every month without action.", S["objection_a"]))
...
story.append(Paragraph(
    "Total: $8,047/mo + $4,000-$5,000 ad spend  |  Save $1,147/mo by bundling  |  ~19% of revenue (under 35% cap)",
    S["savings"]))
