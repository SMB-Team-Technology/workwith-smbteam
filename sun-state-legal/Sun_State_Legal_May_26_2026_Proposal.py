...
# Report metadata
FIRM_NAME      = "Sun State Legal PLLC"
SALES_REP      = "Jonathan Farace"
OUTPUT_PATH    = "sun-state-legal/Sun_State_Legal_May_26_2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL",  "100% referrals only"),    # Lead Generation
    ("RED",   "CRITICAL",  "Leads go cold daily"),     # Intake
    ("RED",   "CRITICAL",  "No staff or structure"),   # Team
    ("AMBER", "IN PROGRESS", "No KPIs or plan"),       # Profit Plan
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "No marketing system — firm stops the moment Nate does"),
    ("neg", "4–5 cases/wk go cold — $30K–$100K+ in annual invisible leakage"),
    ("neg", "No team or leverage — every new case adds directly to Nate's hours"),
    ("pos", "Super Lawyer 2024–26, 15 yrs experience, $500K revenue with zero ads"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("JacksonWhite Law",          "681+ Google reviews", "3 locations · dominant East Valley"),
    ("Shields Petitti & Zoldan",  "5.0★ Google",    "6-atty employment boutique · PPC"),
    ("Houk Employment Attorneys", "28 Google reviews",   "Employment-only · non-compete focus"),
]
CLIENT_REVIEWS      = "10 Avvo reviews"
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $1M Revenue"

SMB_MODEL_DESC = (
    "Four pillars — Lead Gen, Intake, Team, and Profit — each one amplifies the next. "
    "Get all four working and Nate stops being the business "
    "and starts owning one that runs without him."
)

GOAL_HEADLINE = "$500K → $1M revenue"
GOAL_DBM      = "Build something that runs — and lasts for your son"
...
PRIORITIES = [
    (
        ...
        [
            ...
            "Launch Ads: capture employment searches you're missing",
            "Activate Google Screened LSA — top of every search",
            "Rebuild site: practice area pages + above-fold CTA",
            "Build to 20+ Google reviews in 60 days",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Stop 4–5 cases/week from going cold in voicemail",
            "Build a 15-minute response standard for every lead",
            "Create qualification script + lead tracking log",
            "Add after-hours coverage — capture the 7pm calls",
            "Know every lead that came in and what happened to it",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Build a 3-year vision and quarterly accountability plan",
            "Define the first hire + scope before you commit",
            "Track margin by case type — find where profit lives",
            "Set a wealth target, not just a revenue floor",
            "Build org structure so the firm outlasts any one person",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,847", "$5,697/mo",
        "Website rebuild · Google Ads · LSA · Local SEO · GBP optimization",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
        "$3,200", "$3,497/mo",
        "Weekly group coaching · KPI framework · Masterminds · Workshops",
        "6D28D9",
    ),
]
...
AD_SPEND_NOTE = (
    "+ Recommended ad spend: $4,000–$5,000/mo paid directly to Google/Meta"
)

AVG_CASE_VALUE     = "$5,000–$15,000"
CONSERVATIVE_LABEL = "Conservative  (2–3 cases/mo):"
CONSERVATIVE_RESULT = "$10K–$15K revenue · ~3× ROAS"
AGGRESSIVE_LABEL   = "Aggressive  (4–5 cases/mo):"
AGGRESSIVE_RESULT  = "$32K–$40K revenue · ~7× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Website rebuild + ad campaign strategy begins"),
    ("Day 14",  "Google Ads + LSA campaigns go live"),
    ("Week 2",  "GBP fully optimized; review system activated"),
    ("Week 3",  "Coaching kickoff: 3-year vision + KPIs set"),
    ("Month 3", "Intake triage live; 20+ Google reviews earned"),
]

CLOSING_QUOTE = (
    "“You wanted to build something you own, something that runs without you, "
    "something that could one day mean something for your son — "
    "that is exactly what this plan builds.”"
)
