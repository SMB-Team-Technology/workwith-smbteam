...
Output: conner-roberts/Conner_Roberts_June30_2026_Proposal.pptx
"""
...
# Report metadata
FIRM_NAME      = "Conner & Roberts, PLLC"
SALES_REP      = "Jonathan Farace"
OUTPUT_PATH    = "conner-roberts/Conner_Roberts_June30_2026_Proposal.pptx"
...
PILLARS = [
    ...
    ("AMBER", "AMBER", "Form buried below fold"),    # Intake
    ("AMBER", "AMBER", "Partners at 60+ hrs/wk"),   # Team
    ("AMBER", "AMBER", "Manual collections"),        # Profit Plan
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "Zero paid search presence — competitors take every family law inquiry Conner & Roberts never sees"),
    ("neg", "Lisa at capacity: 60+ hr weeks with 10-20 hrs lost to manual retainer collections"),
    ("neg", "3 phone numbers and 2 addresses indexed across directories suppress every local 3-pack result"),
    ("pos", "102 Google reviews at 4.7 stars — the highest review volume of any Chattanooga family law firm"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Ryan Hanzelik Attorney at Law",  "83 Google reviews", "5.0 ★ · family law"),
    ("Horton, Ballard & Pemerton",     "4.6 ★ NoogaFinder",  "100 yrs exp · family law"),
    ("Angela C. Larkins, Atty.",       "36 reviews",        "Solo · CDFA credential"),
]
CLIENT_REVIEWS      = "102 reviews · 4.7 ★"
CLIENT_REVIEWS_NOTE = "← Most reviews locally"
...
SMB_MODEL_DESC = (
    "Lead generation, intake, a self-managing team, and profit must all "
    "work together. When all four pillars run without daily partner "
    "involvement, Amelia and Lisa can step back and let the firm work for "
    "them — building something scalable, sellable, and worth owning."
)

GOAL_HEADLINE = "$3M → $5M revenue"
GOAL_DBM      = "Step back and let the firm work for you"
...
PRIORITIES = [
    (
        ...
        [
            "Turn Google into a paid client pipeline",
            "Get Google Screened — 102 reviews qualify now",
            "Fix 3 phone numbers suppressing 3-pack rank",
            "Restart blog — inactive since January 2025",
    ...
    (
        ...
        [
            ...
            "Add automated after-hours response system",
            "Build follow-up sequence for unsigned leads",
            "Remove partners from billing escalation calls",
            "Track lead-to-consult rate by channel",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Automate collections — return 10-20 hrs to Lisa",
            "AI review for uncontested divorce documents",
            "Define roles for all 5 support staff members",
            "Add monthly financial KPI dashboard",
            "Build an ops layer that runs without partners",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$7,397", "$8,997/mo",
        "Google Ads · LSA · Meta · SEO · GBP optimization",
        "1D4ED8",
    ),
    (
        "MASTER'S CIRCLE",
        "$4,600", "$4,997/mo",
        "Weekly coaching · masterminds · exit planning",
        "6D28D9",
    ),
]

BUNDLE_TOTAL   = "$16,994 / mo"
BUNDLE_SAVINGS = "Save $2,797/mo by bundling all 3 packages"

AD_SPEND_NOTE = (
    "+ Ad spend: $3,500–$14,000/mo direct to Google/Meta  ·  AI Accelerator L2 also included: $4,997/mo bundled"
)

AVG_CASE_VALUE      = "$8,750"
CONSERVATIVE_LABEL  = "Conservative  (3 cases/mo):"
CONSERVATIVE_RESULT = "$26,250 revenue · 7.5× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (17 cases/mo):"
AGGRESSIVE_RESULT   = "$148,750 revenue · 10× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Google Ads & LSA campaigns launched"),
    ("Day 14",  "Website form above fold; mobile CTA live"),
    ("Week 2",  "AI collections workflow built for Lisa"),
    ("Week 3",  "NAP corrected across all directories"),
    ("Month 3", "AI doc review live; all KPIs on dashboard"),
]

CLOSING_QUOTE = (
    "“Build a scalable, sellable firm — so one day we step back as owners, not practitioners.”"
)
