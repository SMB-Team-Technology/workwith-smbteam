...
Output: sumner/SumnerPC_June30_2026_Proposal.pptx
"""
...
# Report metadata
FIRM_NAME      = "Sumner & Associates, P.C."
SALES_REP      = "Randy Gold"
OUTPUT_PATH    = "sumner/SumnerPC_June30_2026_Proposal.pptx"
...
PILLARS = [
    ...
    ("AMBER", "AMBER",     "Buried contact form"),    # Intake
    ("AMBER", "AMBER",     "Founder-dependent ops"),  # Team
    ("AMBER", "AMBER",     "No practice tracking"),   # Profit Plan
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

# Key findings — list of ("neg"|"pos", "one-sentence finding")
FINDINGS = [
    ("neg", "Zero paid ads on any channel — competitors win every Rochester Hills family law and estate planning search"),
    ("neg", "Contact form buried below fold — only a fraction of existing organic traffic converts to consultations"),
    ("neg", "Google Business Profile performance unverified — 3-pack position at risk as competitors invest in reviews"),
    ("pos", "4.9★ Avvo (150+ reviews) and AV Preeminent 2026 — exceptional credibility ready to be amplified online"),
]

# Competitor table — list of (name, "XXX reviews", "brief note")
COMPETITORS = [
    ("Little & Boylan PLLC",  "47 reviews",    "4.9★ · paid family law ads"),
    ("Rutkowski Law Firm",    "~57 reviews",   "4.9★ · Asset Shield estate brand"),
    ("Michigan Auto Law",     "3,000+ reviews","dominates Oakland County PI"),
]
CLIENT_REVIEWS      = "Avvo: 150+ (★ 4.9)"
...
SMB_MODEL_DESC = (
    "When Lead Generation, Intake, Team, and Profit all align, "
    "a law firm grows beyond its founder. "
    "Scott's goal — a firm that runs without him — "
    "is exactly what this plan builds."
)
...
PRIORITIES = [
    (
        ...
        [
            "Turn Google into a lead pipeline that runs daily",
            "Launch LSA — top of Google, pay per real lead",
            "Google Ads for family law and estate planning",
            "Reclaim estate planning searches from Rutkowski",
            "Meta retargeting turns past visitors to clients",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Move contact form above fold — stop losing leads",
            "Add after-hours text option for evening visitors",
            "Formalize intake scripts for Maryanne's team",
            "Automate follow-up for every new form submission",
            "Fix mobile speed — stop losing evening visitors",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Document SOPs so the firm runs without Scott",
            "Weekly KPI dashboards by practice area",
            "Track case economics across all four offices",
            "Set a monthly profit target and track it",
            "Build accountability structure for Sarah Aldred",
        ],
    ),
]
...
PACKAGES = [
    (
        ...
        "$4,847", "$5,697/mo",
        "Google Ads · LSA · Meta Ads · Website CRO · GBP optimization",
        "1D4ED8",
    ),
    (
        "ELITE COACH PLUS",
...
AVG_CASE_VALUE      = "$3,800"
CONSERVATIVE_LABEL  = "Conservative  (8 cases/mo):"
CONSERVATIVE_RESULT = "$30,000 revenue · 4.0× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (30 cases/mo):"
AGGRESSIVE_RESULT   = "$115,000 revenue · 4.5× ROAS"

# Timeline — 5 items: (milestone_label, action_text)
TIMELINE = [
    ("Day 1",   "Coaching kickoff and 90-day KPI alignment"),
    ("Day 14",  "Google Ads launched — family law & estate planning"),
    ("Week 2",  "LSA verification submitted; Meta retargeting live"),
    ("Week 3",  "Website CTA above fold; mobile speed addressed"),
    ("Month 3", "First digital cases closed; ROI review + Phase 2"),
]

CLOSING_QUOTE = (
    "“The leads are in this market — and right now, "
    "every one of them is going to someone else.”"
)
