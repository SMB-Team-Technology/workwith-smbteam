"""
Audit PowerPoint — Lone Star Legal
SMB Team | Sales Rep: Nick Holderman | June 18, 2026
"""
...
# ═══════════════════════════════════════════════════════════════════
# FILLED DATA — Lone Star Legal
# ═══════════════════════════════════════════════════════════════════

FIRM_NAME   = "Lone Star Legal"
SALES_REP   = "Nick Holderman"
OUTPUT_PATH = "lone-star-legal/LoneStarLegal_June18_2026_Proposal.pptx"
...
PILLARS = [
    ("RED",   "CRITICAL",  "No paid ads active"),
    ("AMBER", "AMBER",     "After-hours gap"),
    ("AMBER", "AMBER",     "Team underutilized"),
    ("AMBER", "AMBER",     "No profit clarity"),
]
PILLAR_NAMES = ["Lead Generation", "Intake", "Team", "Profit Plan"]

FINDINGS = [
    ("neg", "No paid ads on any channel — competitors capture all Georgetown PI digital traffic"),
    ("neg", "Absent from local 3-pack — NAP inconsistency and review gap actively suppressing rankings"),
    ("neg", "Office closes at 5 PM — no after-hours intake for accident victims calling nights and weekends"),
    ("pos", "Board Certified PI attorney + 9-person team + Georgetown office — strongest local credentials in the market"),
]

COMPETITORS = [
    ("Angel Reyes & Associates", "790+ reviews", "5.0★ · Georgetown page"),
    ("The Carlson Law Firm",     "408 reviews",  "4.8★ · 8 mi away"),
    ("The Von Flatern Law Firm", "142 reviews",  "4.9★ · Bd Cert. PI"),
]
...
# ── Slide 2 ──────────────────────────────────────────────────────
SLIDE_2_TITLE = "Your Growth Plan: 3 Priorities to Reach $95,000/Month"

SMB_MODEL_DESC = (
    "Lead Generation, Intake, Team, and Profit work as a system. "
    "Fix one without the others and growth stalls. "
    "When all four run together, Robbye can step away and trust the firm generates cases, "
    "converts them, and keeps what it earns — without her in every decision."
)

GOAL_HEADLINE = "$570K → $1.14M revenue"
GOAL_DBM      = "A firm that runs itself"

PRIORITIES = [
    (
        "Build the", "Marketing Engine", "1D4ED8",
        [
            "Launch Google Ads for Georgetown PI terms",
            "Activate Local Service Ads (Google Screened)",
            "Fix NAP inconsistency across all directories",
            "Optimize GBP to win the local 3-pack",
            "Build review velocity — close the gap with Angel Reyes",
        ],
    ),
    (
        "Fix Intake &", "Stop Losing Cases", "0F766E",
        [
            "Add after-hours answering — cases happen at night",
            "Move contact form above the fold on homepage",
            "Define follow-up sequence for every lead",
            "Track intake conversion rate — know what's leaking",
            "Convert more leads already in the pipeline",
        ],
    ),
    (
        "Install Team &", "Profit Systems", "6D28D9",
        [
            "Weekly KPI reviews with the 9-person team",
            "Define role clarity and performance metrics",
            "Track profitability by case type",
            "Set monthly case and revenue targets",
            "Build accountability that runs without Robbye",
        ],
    ),
]
...
CONSERVATIVE_RESULT = "$22,500 revenue · 2.3× ROAS"
AGGRESSIVE_LABEL    = "Aggressive  (11 cases/mo):"
AGGRESSIVE_RESULT   = "$82,500 revenue · 3.3× ROAS"

TIMELINE = [
    ("Day 1",    "Ads strategy kickoff and account setup"),
    ("Day 14",   "Google Ads and LSA campaigns go live"),
    ("Week 3",   "Website optimized; directory listings corrected"),
    ("Month 1",  "Review generation process launched"),
    ("Month 3",  "Local 3-pack rankings improving; ROI review"),
]

CLOSING_QUOTE = (
    "“A year from now, Lone Star Legal is the firm Georgetown accident victims "
    "find first — and Robbye knows exactly how many cases are coming before the month starts.”"
)
