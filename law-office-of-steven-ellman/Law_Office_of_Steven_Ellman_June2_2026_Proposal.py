...
# Report metadata
FIRM_NAME      = "Law Office of Steven Ellman"
SALES_REP      = "Nick Holderman"
OUTPUT_PATH    = "law-office-of-steven-ellman/Law_Office_of_Steven_Ellman_June2_2026_Proposal.pptx"
...
PILLARS = [
    ("AMBER", "AMBER",    "No paid ads on any channel"),
    ("AMBER", "AMBER",    "No after-hours coverage"),
    ("RED",   "CRITICAL", "Solo attorney, no structure"),
    ("AMBER", "AMBER",    "No profit plan in place"),
]
...
COMPETITORS = [
    ...
    ("Rosenberg Perry & Associates",       "325 reviews", "5.0 ★ · Burlington Co. seat"),
]
...
SMB_MODEL_DESC = (
    ...
    "all four must work together. When the system is built, Steven can "
